...
-- All The File By Developer EORO : @S_X_X_G 
...
if res ~= 200 then
io.write("\27[31;47m◼¦ حدث خطأ في الاتصال بالسيرفر ، يرجى مراسلة مطور السورس { @S_X_X_G  } ليتمكن من حل المشكلة في اسرع وقت ممكن! \27[0;m\n")
os.exit()
end
Getresult, Getuser = pcall(JSON.decode, url)
if not Getresult then
io.write("\27[31;47m◼¦ حدث خطأ في سكرب الاستخراج ، يرجى مراسلة مطور السورس { @S_X_X_G  } ليتمكن من حل المشكلة في اسرع وقت ممكن! \27[0;m\n")
os.exit()
end
...
local RUNER = io.open("RUNEO .sh", 'w')
RUNER:write([[
#!/usr/bin/env bash
cd $(cd $(dirname $0); pwd)
token="]]..token..[["
...
local banned = faederdx1:sismember(EORO..hash, user_id)
if banned then
var = true
end return var end
--     By Developer EORO     -- 
...
local muted = faederdx1:sismember(EORO..hash, user_id)
if muted then
var = true
end return var end
--     By Developer EORO     -- 
...
local var = false
local hash = 'bot:gban:'
local gbanned = faederdx1:sismember(EORO..hash, user_id)
if gbanned then
var = true 
end return var end
--     By Developer EORO     -- 
...
local mutedall = faederdx1:sismember(EORO..hash, user_id)
if mutedall then
var = true
end return var end
--     By Developer EORO     -- 
...
local user_id
local user = false
local list1 = faederdx1:smembers(EORO.."Bot:KpSudos")
local list2 = faederdx1:smembers(EORO.."Bot:Admins")
for k, v in pairs(list1) do
local hash = "sudo:data:" .. v
local is_add = faederdx1:sismember(EORO..hash, chat)
if is_add then
user_id = v
end end
...
if faederdx1:sismember(EORO..hash, chat) then
user_id = bot_owner
end
if user_id then
local user_info = faederdx1:get(EORO.."user:Name" .. user_id)
if user_info then
user = user_info
...
local info_file = io.open('./'..EORO..'.json', "r"):read('*a')
local groups = JSON.decode(info_file)
faederdx113(chat,msg.id_,"*⌯︙تم رفع نسخه الملف ،\n⌯︙تم رفع مشرفين المجموعات ،\n⌯︙تم قفل اوامر حمايه المجموعات ،*")
vardump(groups)
for idg,v in pairs(groups.GP_BOT) do
faederdx1:sadd(EORO.."bot:groups",idg)
faederdx1:set(EORO.."bot:enable:"..idg,true)
faederdx1:setex(EORO.."bot:charge:"..idg,86400,true)
faederdx1:sadd("faeder:addg"..bot_id, idg) faederdx1:set(EORO..'editmsg'..idg,true)
faederdx1:set(EORO..'bot:bots:mute'..idg,true) faederdx1:set(EORO..'bot:bots:ban'..idg,true)
faederdx1:set(EORO..'keed_bots'..idg,true) faederdx1:set(EORO..'anti-flood:'..idg,true)
faederdx1:set(EORO..'bot:inline:mute'..idg,true) faederdx1:set(EORO..'bot:photo:mute'..idg,true)
faederdx1:set(EORO..'bot:spam:mute'..idg,true) faederdx1:set(EORO..'bot:video:mute'..idg,true)
faederdx1:set(EORO..'bot:gifs:mute'..idg,true) faederdx1:set(EORO..'tags:lock'..idg,true)
faederdx1:set(EORO..'bot:music:mute'..idg,true) faederdx1:set(EORO..'bot:voice:mute'..idg,true)
faederdx1:set(EORO..'bot:links:mute'..idg,true) faederdx1:set(EORO..'bot:location:mute'..idg,true) 
faederdx1:set(EORO..'bot:strict'..idg,true) faederdx1:set(EORO..'bot:document:mute'..idg,true) 
faederdx1:set(EORO..'bot:hashtag:mute'..idg,true) faederdx1:set(EORO..'bot:contact:mute'..idg,true) 
faederdx1:set(EORO..'bot:webpage:mute'..idg,true) faederdx1:set(EORO..'bot:sticker:mute'..idg,true)
faederdx1:set(EORO..'markdown:lock'..idg,true) faederdx1:set(EORO..'bot:forward:mute'..idg,true)
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
faederdx1:sadd(EORO..'bot:monsh:'..idg,idmsh)  
print('تم رفع '..k..' منشئين')
end end
if v.MDER then
for k,idmder in pairs(v.MDER) do
faederdx1:sadd(EORO..'bot:owners:'..idg,idmder)  
print('تم رفع '..k..' مدراء')
end end
if v.MOD then
for k,idmod in pairs(v.MOD) do
vardump(idmod)
faederdx1:sadd(EORO..'bot:momod:'..idg,idmod)  
print('تم رفع '..k..' ادمنيه')
end end
if v.VIP then
for k,idvip in pairs(v.VIP) do
faederdx1:sadd(EORO..'bot:vipmem:'..idg,idvip)  
print('تم رفع '..k..' مميزين')
end end
if v.linkgroup then
if v.linkgroup ~= "" then
faederdx1:set(EORO.."bot:group:link"..idg,v.linkgroup)   
print('تم وضع رابط ')
end end end end
--     By Developer EORO     -- 
-------- Resolve Username
...
faeder = faederdx1:get(EORO.."bot:sudo:add"..chat_id) or "المطور الثانوي"
elseif is_admin(user_id) then
faeder = faederdx1:get(EORO.."bot:sudo3:add"..chat_id) or "المطور الثالث"
elseif is_onall(user_id) then
faeder = faederdx1:get(EORO.."bot:onall:add"..chat_id) or "المدير العام"
elseif is_moall(user_id) then
faeder = faederdx1:get(EORO.."bot:moall:add"..chat_id) or "الادمن العام"
elseif is_monsh(user_id,chat_id) then
faeder = faederdx1:get(EORO.."bot:monsh:add"..chat_id) or "المنشئ الاساسي"
elseif is_monsh2(user_id,chat_id) then
faeder = faederdx1:get(EORO.."bot:monsh2:add"..chat_id) or "المنشئ"
elseif is_owner(user_id,chat_id) then
faeder = faederdx1:get(EORO.."bot:owner:add"..chat_id) or "المدير"
elseif is_momod(user_id,chat_id) then
faeder = faederdx1:get(EORO.."bot:momod:add"..chat_id) or "الادمن"
elseif is_vipmem(user_id,chat_id) then
faeder = faederdx1:get(EORO.."bot:vepmem:add"..chat_id) or "المميز"
else
faeder = faederdx1:get(EORO.."bot:member:add"..chat_id) or "العضو" 
end return faeder end
--     By Developer EORO     -- 
function dxdx(user_id,chat_id)
if is_leaderid(user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:admins:', user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:onall:', user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:moall:', user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:vpall:', user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:monsh:'..chat_id, user_id) then
var = true
elseif is_monsh(chat_id, user_id) then
var = true
elseif faederdx1:sismember(EORO..'bot:monsh2:'..chat_id, user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:owners:'..chat_id, user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:momod:'..chat_id, user_id) then
var = true  
elseif faederdx1:sismember(EORO..'bot:vipmem:'..chat_id, user_id) then  
var = true  
...
local hash = (EORO..'bot:filters:'..msg.chat_id_)
if hash then
local names = faederdx1:hkeys(hash)
local text = ''
local value = value:gsub(' ','')
...
faederdx1:set(EORO.."bot:enable:"..chat_id, true) 
faederdx1:sadd(EORO..'bot:groups',chat_id)
end 
function remgroup(chat_id) 
faederdx1:srem("faeder:addg"..bot_id,chat_id) 
faederdx1:del(EORO.."bot:enable:"..chat_id, true)  faederdx1:srem(EORO..'bot:groups',chat_id)
end
local function remlockal(chat_id)
faederdx1:del(EORO..'editmsg'..chat_id) faederdx1:del(EORO..'bot:cmds'..chat_id) faederdx1:del(EORO..'bot:bots:mute'..chat_id) faederdx1:del(EORO..'bot:bots:ban'..chat_id) faederdx1:del(EORO..'keed_bots'..chat_id) faederdx1:del(EORO..'anti-flood:'..chat_id) faederdx1:del(EORO..'bot:pin:mute'..chat_id) faederdx1:del(EORO..'bot:photo:mute'..chat_id) faederdx1:del(EORO..'bot:spam:mute'..chat_id) faederdx1:del(EORO..'bot:video:mute'..chat_id) faederdx1:del(EORO..'bot:document:mute'..chat_id) faederdx1:del(EORO..'bot:inline:mute'..chat_id) faederdx1:del(EORO..'markdown:lock'..chat_id) faederdx1:del(EORO..'bot:gifs:mute'..chat_id) faederdx1:del(EORO..'bot:music:mute'..chat_id) faederdx1:del(EORO..'bot:voice:mute'..chat_id) faederdx1:del(EORO..'bot:links:mute'..chat_id) faederdx1:del(EORO..'bot:location:mute'..chat_id) faederdx1:del(EORO..'tags:lock'..chat_id) faederdx1:del(EORO..'bot:strict'..chat_id) faederdx1:del(EORO..'bot:hashtag:mute'..chat_id) faederdx1:del(EORO..'bot:contact:mute'..chat_id) faederdx1:del(EORO..'bot:webpage:mute'..chat_id) faederdx1:del(EORO..'bot:sticker:mute'..chat_id) faederdx1:del(EORO..'bot:forward:mute'..chat_id)
end
local function addlockal(chat_id)
faederdx1:set(EORO..'editmsg'..chat_id,true) faederdx1:set(EORO..'bot:cmds'..chat_id,true) faederdx1:set(EORO..'bot:bots:mute'..chat_id,true) faederdx1:set(EORO..'bot:bots:ban'..chat_id,true) faederdx1:set(EORO..'keed_bots'..chat_id,true) faederdx1:set(EORO..'anti-flood:'..chat_id,true) faederdx1:set(EORO..'bot:pin:mute'..chat_id,true) faederdx1:set(EORO..'bot:inline:mute'..chat_id,true) faederdx1:set(EORO..'bot:photo:mute'..chat_id,true) faederdx1:set(EORO..'bot:spam:mute'..chat_id,true) faederdx1:set(EORO..'bot:video:mute'..chat_id,true) faederdx1:set(EORO..'bot:gifs:mute'..chat_id,true) faederdx1:set(EORO..'bot:music:mute'..chat_id,true) faederdx1:set(EORO..'bot:voice:mute'..chat_id,true) faederdx1:set(EORO..'bot:links:mute'..chat_id,true) faederdx1:set(EORO..'bot:location:mute'..chat_id,true) faederdx1:set(EORO..'tags:lock'..chat_id,true) faederdx1:set(EORO..'bot:strict'..chat_id,true) faederdx1:set(EORO..'bot:document:mute'..chat_id,true) faederdx1:set(EORO..'bot:hashtag:mute'..chat_id,true) faederdx1:set(EORO..'bot:contact:mute'..chat_id,true) faederdx1:set(EORO..'bot:webpage:mute'..chat_id,true) faederdx1:set(EORO..'bot:sticker:mute'..chat_id,true) faederdx1:set(EORO..'markdown:lock'..chat_id,true) faederdx1:set(EORO..'bot:forward:mute'..chat_id,true)
end
--     By Developer EORO     -- 
...
faederdx1:set(EORO..'bot:group:name'..GroupID,data.title_) 
end,nil) 
return faederdx1:get(EORO..'bot:group:name'..GroupID)  end
--     By Developer EORO     -- 
function faedrmoned(chat_id, user_id, msg_id, text, offset, length) local tt = faederdx1:get(EORO..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     By Developer EORO     -- 
...
local our_id = faederdx1:get(EORO.."Our_ID") or 0
local api_id = faederdx1:get(EORO.."Bot:Api_ID") or 0
...
if Text == '/UnKed' then 
if faederdx1:sismember(EORO.."faederdx1:Un:Ked"..data.chat_id_,data.sender_user_id_) then
...
faederdx1:srem(EORO.."faederdx1:Un:Ked"..Chat_id,data.sender_user_id_)
delete_msg(data.chat_id_, {[0] = Msg_id})  
end end end
--     By Developer EORO     -- 
...
faederdx1:sadd(EORO..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_)
elseif fdrt == "ادمن" and is_owner(msg.sender_user_id_, msg.chat_id_) then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'faeder_ch')..')'..' )\n⌯︙*تم رفعه ( '..faederrt..' )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
faederdx1:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,faederrt)
faederdx1:sadd(EORO..'bot:momod:'..msg.chat_id_, result.sender_user_id_)
elseif fdrt == "مدير" and is_monsh(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'faeder_ch')..')'..' )\n⌯︙*تم رفعه ( '..faederrt..' )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
faederdx1:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,faederrt)  
faederdx1:sadd(EORO..'bot:owners:'..msg.chat_id_, result.sender_user_id_)
...
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif fdrt == "ادمن" and is_owner(msg.sender_user_id_, msg.chat_id_) then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'faeder_ch')..')'..' )\n⌯︙*تم تنزيله من ( '..faederrt..' )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.sender_user_id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif fdrt == "مدير" and is_monsh(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'faeder_ch')..')'..' )\n⌯︙*تم تنزيله من ( '..faederrt..' )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.sender_user_id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif fdrt == "عضو" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'faeder_ch')..')'..' )\n⌯︙*تم تنزيله من ( '..faederrt..' )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
end end,nil) end   
...
faederdx1:sadd(EORO..'bot:vipmem:'..msg.chat_id_, result.id_)
faederdx1:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif fdrt == "ادمن" and is_owner(msg.sender_user_id_, msg.chat_id_) then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم رفعه ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
faederdx1:sadd(EORO..'bot:momod:'..msg.chat_id_, result.id_)
faederdx1:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif fdrt == "مدير" and is_monsh(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم رفعه ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
faederdx1:sadd(EORO..'bot:owners:'..msg.chat_id_, result.id_)
faederdx1:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif fdrt == "عضو" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم رفعه ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
end else
...
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif fdrt == "ادمن" and is_owner(msg.sender_user_id_, msg.chat_id_) then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم تنزيله من ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif fdrt == "مدير" and is_monsh(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم تنزيله من ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.id_)
faederdx1:del(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif fdrt == "عضو" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'faeder_ch')..')'..' )\n⌯︙تم تنزيله من ( '..text1[2]..' )\n⌯︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
end else
...
faederdx1:incr(EORO..'msg'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'arg' 
elseif id:match("^(%d+)") then
faederdx1:sadd(EORO..'bot',msg.sender_user_id_)  
Chat_Type = 'pv' 
else
Chat_Type = 'sup' 
end end 
...
local users = faederdx1:scard(EORO.."bot:userss")
faederdx(tostring((faederdx1:get(EORO.."bot:leader:gr") or bot_owner)), 0, 1, "⌯︙ هذا دز ستارت للبوت \n⌯︙معرفه ⌯» @"..(result.username_ or "لا يوجد").."\n⌯︙ايديه ⌯» {"..msg.sender_user_id_.."}\n⌯︙اصبح عدد المشتركين { "..users.." }" , 1, 'html')
end 
...
function adding(extra,result,success)
faederdx(tostring((faederdx1:get(EORO.."bot:leader:gr") or bot_owner)), 0, 1, "⌯︙هذا دزوله همسه وديشوفها \n⌯︙معرفه ⌯» @"..(result.username_ or "لا يوجد").."\n⌯︙ايديه ⌯» {"..msg.sender_user_id_.."}" , 1, 'html') 
end 
getUser(msg.sender_user_id_,adding) 
end end 
--     By Developer EORO     -- 
...
if not faederdx1:get(EORO..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..( SudoEORO or "Faeder_ch")}}}
...
local start = faederdx1:get(EORO.."Start:Bot")
if start then 
Start_Source = start
else
...
faederdx1:setex(EORO..'Start:Time'..msg.sender_user_id_,300,true)
return false
end end
if text and faederdx1:get(EORO..'Start:Bots') then
if text == 'الغاء' then   
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ كليشة الستارت .', 1, 'md')
faederdx1:del(EORO..'Start:Bots') 
return false
end
faederdx1:set(EORO.."Start:Bot",text)  
...
faederdx1:set(EORO..'Start:Bots',true) 
...
if Chat_Type == 'pv' then   
if not is_leader(msg) and not faederdx1:sismember(EORO..'BaN:In:User',msg.sender_user_id_) and not faederdx1:get(EORO..'Texting:In:Bv') then
faederdx(msg.sender_user_id_, msg.id_, 1, '⌯︙تم ارسال رسالتك الى [مطور البوت](t.me/'..SudoEORO..')', 1, 'md')
...
faederdx1:sadd(EORO..'BaN:In:User',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then 
local Text = '⌯︙تم الغاء حظره من التواصل بنجاح .'
sendText(bot_owner,Text,msg.id_/2097152/0.5,'md') 
faederdx1:srem(EORO..'BaN:In:User',data.id_)  
return false 
end 
...
faederdx1:del(EORO..'Texting:In:Bv') 
end
if text == 'تعطيل التواصل' then  
local faeder = '⌯︙اهلا عزيزي '..renk_faeder(msg)..'\n⌯︙تم تعطيل التواصل .'
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md') 
faederdx1:set(EORO..'Texting:In:Bv',true) 
end end
--     By Developer EORO     -- 
faederdx1:sadd(EORO.."groups:users" .. msg.chat_id_, msg.sender_user_id_)--save users gp
faederdx1:incr(EORO.."msgs:"..msg.sender_user_id_..":"..msg.chat_id_.."")--save msgs gp
if msg.content_.ID == "MessageChatDeleteMember" then
if tonumber(msg.content_.user_.id_) == tonumber(bot_id) then
faederdx1:del(EORO.."bot:enable:" .. msg.chat_id_)
faederdx1:srem(EORO.."bot:groups", msg.chat_id_) 
end end 
...
if text and not faederdx1:get(EORO..'lock:bot:ttt'..bot_id) and not faederdx1:get(EORO.."lock:bot:ttt2:"..msg.chat_id_) then 
...
faederdx1:set(EORO.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
end
--     By Developer EORO     -- 
local msg = data.message_
text = msg.content_.text_
...
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and faederdx1:get(EORO.."bot:bots:ban" .. msg.chat_id_) and not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and faederdx1:get(EORO.."bot:bots:mute" .. msg.chat_id_) and not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
chat_kick(msg.chat_id_,mem_id[i].id_)
end end end
--     By Developer EORO     -- 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and faederdx1:get(EORO.."keed_bots"..msg.chat_id_)  and not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
chat_kick(msg.chat_id_,mem_id[i].id_)
faederdx1:sadd(EORO..'bot:keed:'..msg.chat_id_, msg.sender_user_id_)
...
if faederdx1:get(EORO..'bot:tgservice:jk'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)    
...
if text ==('تفعيل') and not is_admin(msg.sender_user_id_, msg.chat_id_) and not faederdx1:get(EORO..'lock:bot:free'..bot_id) and faeder11(msg) then
function adding(extra,result,success)
local function promote_admin(extra, result, success)
local num = 0
...
for i=0 , #admins do   
num = num + 1
faederdx1:sadd(EORO..'bot:momod:'..msg.chat_id_,admins[i].user_id_)
if result.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
faederdx1:sadd(EORO.."bot:monsh:"..msg.chat_id_,owner_id)
end end end
getChannelMembers(msg.chat_id_, 0, 'Administrators', 200, promote_admin)
if not is_admin(msg.sender_user_id_, msg.chat_id_) then
if faederdx1:get(EORO.."bot:enable:"..msg.chat_id_) then
...
faederdx1:set(EORO.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
faederdx(tostring((faederdx1:get(EORO.."bot:leader:gr") or bot_owner)), 0, 1, "⌯︙تم تفعيل مجموعه جديده  \n⌯︙معرف الضافني ⌯» @"..(result.username_ or "لا يوجد").."\n⌯︙ايدي الضافني ⌯» `"..msg.sender_user_id_.."`\n⌯︙معلومات المجموعه ،  \n\n⌯︙اسم المجموعه ⌯»  *"..f2.title_.."*\n⌯︙ايدي المجموعه ⌯» `"..msg.chat_id_.."`\n⌯︙رابط المجموعه ، \n⌯︙"..(t2.invite_link_ or "Error").."\n" , 1, 'md')
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID 
...
openChat(msg.chat_id_,faeder) 
faederdx1:set(EORO.."bot:enable:"..msg.chat_id_,true)
faederdx1:setex(EORO.."bot:charge:"..msg.chat_id_,86400,true)
faederdx1:sadd("faeder:addg"..bot_id, msg.chat_id_)
end end end
getUser(msg.sender_user_id_,adding) 
end end  
...
if not faederdx1:get(EORO.."bot:enable:"..msg.chat_id_) and not idf:match("^(%d+)") and not is_admin(msg.sender_user_id_, msg.chat_id_) then
...
--     By Developer EORO     -- 
faederdx1:incr(EORO.."bot:allmsgs")
if msg.chat_id_ then
local id = tostring(msg.chat_id_)
if id:match('-100(%d+)') then
if msg.can_be_deleted_ == true then 
faederdx1:sadd(EORO.."bot:groups",msg.chat_id_)
end
if not faederdx1:sismember(EORO.."bot:groups",msg.chat_id_) then
faederdx1:sadd(EORO.."bot:groups",msg.chat_id_)
end
elseif id:match('^(%d+)') then
if not faederdx1:sismember(EORO.."bot:userss",msg.chat_id_) then
faederdx1:sadd(EORO.."bot:userss",msg.chat_id_)
end else
if not faederdx1:sismember(EORO.."bot:groups",msg.chat_id_) then
faederdx1:sadd(EORO.."bot:groups",msg.chat_id_)
end end end
...
--     By Developer EORO     -- 
 if msg.content_.ID == "MessageChatAddMembers" then
faederdx1:incr(EORO..'bot:user:add'..msg.chat_id_..':'..msg.sender_user_id_)
end
if msg.content_.ID == "MessagePhoto" then
faederdx1:incr(EORO.."Photo:"..msg.sender_user_id_..":"..msg.chat_id_.."")
end
if msg.content_.ID == "MessageAnimation" then
faederdx1:incr(EORO.."Gif:"..msg.sender_user_id_..":"..msg.chat_id_.."")
end
if msg.content_.ID == "MessageVideo" then
faederdx1:incr(EORO.."Video:"..msg.sender_user_id_..":"..msg.chat_id_.."")
end
if msg.content_.ID == "MessageVoice" then
faederdx1:incr(EORO.."Voice:"..msg.sender_user_id_..":"..msg.chat_id_.."")
end
if msg.content_.ID == "MessageSticker" then
faederdx1:incr(EORO.."sticker:"..msg.sender_user_id_..":"..msg.chat_id_.."")
end
--     By Developer EORO     -- 
if msg.content_.ID == "MessageChatJoinByLink" and not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
if faederdx1:get(EORO.."Lock:Join"..msg.chat_id_) then
chat_kick(msg.chat_id_,msg.sender_user_id_) 
return false  
end
end
...
if faederdx1:get(EORO.."UnKedDeleteMessage"..msg.chat_id_) == "open" then
...
faederdx1:sadd(EORO.."faederdx1:Un:Ked"..msg.chat_id_,msg.sender_user_id_)
...
if faederdx1:get(EORO..'bot:setphoto'..msg.chat_id_..':'..msg.sender_user_id_) then
...
faederdx1:del(EORO..'bot:setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
setphoto(msg.chat_id_, photo_id)
end end
--     By Developer EORO     -- 
text = msg.content_.text_ 
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local content_text = faederdx1:get(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
if content_text == 'save_repgp' then 
if text == 'الغاء' then
local delrep_owner = faederdx1:get(EORO..'delrep_owner'..msg.chat_id_..'')
faederdx1:srem(EORO..'rep_owner'..msg.chat_id_..'',delrep_owner)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ الرد . \n', 1, 'md')
faederdx1:del(EORO..'addreplaygp:'..msg.sender_user_id_..''..msg.chat_id_..'')
faederdx1:del(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_)
faederdx1:del(EORO..'delrep_owner'..msg.chat_id_..'')
return false
end
faederdx1:del(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
local content_text = faederdx1:get(EORO..'addreplaygp:'..msg.sender_user_id_..''..msg.chat_id_..'')
if msg.content_.video_ then faederdx1:set(EORO..'video_repgp'..content_text..''..msg.chat_id_..'', msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then faederdx1:set(EORO..'file_repgp'..content_text..''..msg.chat_id_..'', msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then faederdx1:set(EORO..'stecker_repgp'..content_text..''..msg.chat_id_..'', msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then faederdx1:set(EORO..'voice_repgp'..content_text..''..msg.chat_id_..'', msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then faederdx1:set(EORO..'audio_repgp'..content_text..''..msg.chat_id_..'', msg.content_.audio_.audio_.persistent_id_) 
end
if msg.content_.photo_ then
...
faederdx1:set(EORO..'photo_repgp'..content_text..''..msg.chat_id_..'', photo_in_group) 
end
if msg.content_.animation_ then faederdx1:set(EORO..'gif_repgp'..content_text..''..msg.chat_id_..'', msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
faederdx1:set(EORO..'text_repgp'..content_text..''..msg.chat_id_..'', msg.content_.text_)
end 
...
if msg.content_.text_ and not faederdx1:get(EORO..'lock_reeeep'..msg.chat_id_) then 
if faederdx1:get(EORO..'video_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO..'video_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end 
if faederdx1:get(EORO..'file_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO..'file_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end 
if faederdx1:get(EORO..'voice_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO..'voice_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end
if faederdx1:get(EORO..'audio_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO..'audio_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end
if faederdx1:get(EORO..'photo_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO..'photo_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end
if faederdx1:get(EORO..'gif_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO..'gif_repgp'..msg.content_.text_..''..msg.chat_id_..'')) 
end 
if faederdx1:get(EORO..'stecker_repgp'..msg.content_.text_..''..msg.chat_id_..'') then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO..'stecker_repgp'..msg.content_.text_..''..msg.chat_id_..''))
end 
if faederdx1:get(EORO..'text_repgp'..msg.content_.text_..''..msg.chat_id_..'') then
function faeder(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local faederdxs = (faederdx1:get('faeder:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
local user_msgs = faederdx1:get(EORO..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = faederdx1:get(EORO..'text_repgp'..msg.content_.text_..''..msg.chat_id_..'')
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local content_text = faederdx1:get(EORO.."add:repallt"..msg.sender_user_id_)
if content_text == 'save_rep' then
if text == 'الغاء' then
local delrep_sudo = faederdx1:get(EORO..'delrep_sudo')
faederdx1:del(EORO.."rep_sudo",delrep_sudo)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ الرد . \n', 1, 'md')
faederdx1:del(EORO.."addreply2:"..msg.sender_user_id_)
faederdx1:del(EORO.."add:repallt"..msg.sender_user_id_)
faederdx1:del(EORO.."delrep_sudo")
return false
end
faederdx1:del(EORO.."add:repallt"..msg.sender_user_id_)
local content_text = faederdx1:get(EORO.."addreply2:"..msg.sender_user_id_)
if msg.content_.video_ then
faederdx1:set(EORO.."video_repall"..content_text, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
faederdx1:set(EORO.."file_repall"..content_text, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
faederdx1:set(EORO.."stecker_repall"..content_text, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
faederdx1:set(EORO.."voice_repall"..content_text, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
faederdx1:set(EORO.."audio_repall"..content_text, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
faederdx1:set(EORO.."photo_repall"..content_text, photo_in_all_groups)
end
if msg.content_.animation_ then
faederdx1:set(EORO.."gif_repall"..content_text, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
faederdx1:set(EORO.."text_repall"..content_text, msg.content_.text_)
end 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم حفظ الرد . \n', 1, 'md') 
faederdx1:del(EORO.."addreply2:"..msg.sender_user_id_)
faederdx1:del(EORO..'delrep_sudo')
...
if msg.content_.text_ and not faederdx1:get(EORO..'lock_reeeep'..msg.chat_id_) then
if faederdx1:get(EORO.."video_repall"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO.."video_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."file_repall"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO.."file_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."voice_repall"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO.."voice_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."audio_repall"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO.."audio_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."photo_repall"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO.."photo_repall"..msg.content_.text_))
end
if  faederdx1:get(EORO.."gif_repall"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, faederdx1:get(EORO.."gif_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."stecker_repall"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, faederdx1:get(EORO.."stecker_repall"..msg.content_.text_))
end
if faederdx1:get(EORO.."text_repall"..msg.content_.text_) then
function faeder(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local faederdxs = (faederdx1:get('faeder:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
local user_msgs = faederdx1:get(EORO..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = faederdx1:get(EORO.."text_repall"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#msgs',(user_msgs + faederdxs or 'لا يوجد'))
...
if not faederdx1:get(EORO..flmax) then
floodMax = 5
else
floodMax = tonumber(faederdx1:get(EORO..flmax))
end
--     By Developer EORO     -- 
-------- Msg
local pm = 'flood:'..msg.sender_user_id_..':'..msg.chat_id_..':msgs'
if not faederdx1:get(EORO..pm) then
msgs = 0
else
msgs = tonumber(faederdx1:get(EORO..pm))
end
--     By Developer EORO     -- 
-------- Flood Check Time
local TIME_CHECK = 2
...
if faederdx1:get(EORO..'floodstatus'..msg.chat_id_) == 'Kicked' then
...
elseif faederdx1:get(EORO..'floodstatus'..msg.chat_id_) == 'DelMsg' then
del_all_msgs(msg.chat_id_, msg.sender_user_id_)
else
del_all_msgs(msg.chat_id_, msg.sender_user_id_)
end end
...
local id = result.id_
if username then
faederdx1:set(EORO..svuser, "@" .. username)
else
faederdx1:set(EORO..svuser, name)
end end
...
--     By Developer EORO     -- 
if faederdx1:get(EORO..'bot:muteall'..msg.chat_id_) and not is_momod(msg.sender_user_id_, msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
--     By Developer EORO     -- 
faederdx1:incr(EORO..'user:msgs'..bot_id..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
faederdx1:incr(EORO..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
faederdx1:incr(EORO..'group:msgs'..msg.chat_id_)
if msg.content_.ID == "MessagePinMessage" then
if faederdx1:get(EORO..'pinnedmsg'..msg.chat_id_) and faederdx1:get(EORO..'bot:pin:mute'..msg.chat_id_) then
unpinmsg(msg.chat_id_)
local pin_id = faederdx1:get(EORO..'pinnedmsg'..msg.chat_id_)
pinmsg(msg.chat_id_,pin_id,0)
end end
--     By Developer EORO     -- 
if faederdx1:get(EORO..'bot:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
if faederdx1:get(EORO..'lang:gp:'..msg.chat_id_) then
end
faederdx1:del(EORO..'bot:viewget'..msg.sender_user_id_)
else
...
if faederdx1:get(EORO..'anti-flood:'..msg.chat_id_) then
faederdx1:setex(EORO..pm, TIME_CHECK, msgs+1)
end
if msg.forward_info_ then
if faederdx1:get(EORO..'bot:forward:mute'..msg.chat_id_) then
...
if faederdx1:get(EORO..'bot:photo:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:links:mute'..msg.chat_id_) then
...
if faederdx1:get(EORO..'bot:strict'..msg.chat_id_) then
chat_kick(msg.chat_id_, msg.sender_user_id_)
end end end
if faederdx1:get(EORO..'tags:lock'..msg.chat_id_) then
...
if msg.content_.caption_:match("#") then
if faederdx1:get(EORO..'bot:hashtag:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:webpage:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:arabic:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:english:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'markdown:lock'..msg.chat_id_) then
if not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
...
if faederdx1:get(EORO..'bot:document:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:inline:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:sticker:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'get:welcome'..msg.chat_id_) then
text = faederdx1:get(EORO..'get:welcome'..msg.chat_id_)
else
...
if faederdx1:get(EORO.."bot:welcome"..msg.chat_id_) then
...
if faederdx1:get(EORO..'bot:bots:gkgk'..msg.chat_id_) then
...
if faederdx1:get(EORO..'bot:contact:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:music:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:voice:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:location:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:video:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:gifs:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if faederdx1:get(EORO..'bot:bots:gkgk'..msg.chat_id_) and not is_momod(msg.chat_id_, msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
getUser(msg.sender_user_id_,check_username)
faederdx1:set(EORO..'bot:editid'.. msg.id_,msg.content_.text_)
...
if faederdx1:get(EORO..'bot:text:mute'..msg.chat_id_) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
delete_msg(chat,msgs)
...
if not faederdx1:get(EORO..hash) then
sens = 400
else
sens = tonumber(faederdx1:get(EORO..hash))
end
if faederdx1:get(EORO..'bot:spam:mute'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
delete_msg(chat,msgs)
...
--     By Developer EORO     -- 
if faederdx1:get(EORO.."bot:setgroup:link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ الرابط .', 1, 'md')
faederdx1:del(EORO.."bot:setgroup:link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
faederdx1:set(EORO.."bot:group:link"..msg.chat_id_,Link)
...
if faederdx1:get(EORO.."fshar"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
...
if faederdx1:get(EORO.."farsi"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
local id = msg.id_
local msgs = { [0] = id}
local chat = msg.chat_id_
if faederdx1:get(EORO..'far'..msg.chat_id_) == 'thhhh' then
delete_msg(chat, msgs)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙ممنوع التكلم باللغه الفارسيه هنا  ', 1, 'md')   
elseif faederdx1:get(EORO..'far'..msg.chat_id_) == 'bedthhh' then
delete_msg(chat, msgs)
end end end
--     By Developer EORO     -- 
if text:match("ڄ") or text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match(" ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("سکس") or text:match("سکسی") or text:match("کسی") or text:match("دخترا") or text:match("دیوث") or text:match("مک") or text:match("زدن") or text:match("سکس") or text:match("سکسی") or text:match("کسی") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") and is_owner(msg.sender_user_id_, msg.chat_id_) then
if faederdx1:get(EORO.."farsiban"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
local id = msg.id_
local msgs = { [0] = id}
local chat = msg.chat_id_
delete_msg(chat, msgs)
...
if faederdx1:get(EORO.."taf"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
function get_warning(extra,result,success)
local id = msg.id_
local msgs = { [0] = id}
local chat = msg.chat_id_
...
if faederdx1:get(EORO.."kaf"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
function get_warning(extra,result,success)
local id = msg.id_
local msgs = { [0] = id}
local chat = msg.chat_id_
...
----------------******* Started Code Source EORO *******---------
if text == 'جلب نسخه الكروبات' and tonumber(msg.sender_user_id_) == tonumber(bot_owner) then
local list = faederdx1:smembers(EORO..'bot:groups')  
local t = '{"BOT_ID": '..EORO..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = title_name(v) or ''
NAME = NAME:gsub('"','')
NAME = NAME:gsub('#','')
NAME = NAME:gsub([[\]],'')
link = faederdx1:get(EORO.."bot:group:link"..v) or ''
welcome = faederdx1:get(EORO..'welcome:'..v) or ''
MNSH = faederdx1:smembers(EORO..'bot:monsh:'..v)
MDER = faederdx1:smembers(EORO..'bot:owners:'..v)
MOD = faederdx1:smembers(EORO..'bot:momod:'..v)
VIP = faederdx1:smembers(EORO..'bot:vipmem:'..v)
if k == 1 then
t = t..'"'..v..'":{"GP_NAME":"'..NAME..'",'
else
t = t..',"'..v..'":{"GP_NAME":"'..NAME..'",'
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..EORO..'.json', '⌯︙عدد كروبات البوت : '..#list..'',dl_cb, nil)
end
--     By Developer EORO     -- 
...
local Users = faederdx1:smembers(EORO.."Tshake:UsersBot")
local Groups = faederdx1:smembers(EORO..'Tshake:Chek:Groups') 
for i = 1, #Groups do
faederdx1:sadd(EORO..'bot:groups',Groups[i])  
faederdx1:sadd("faeder:addg"..bot_id,Groups[i])  
faederdx1:set(EORO.."bot:enable:"..Groups[i],true)
faederdx1:setex(EORO.."bot:charge:"..Groups[i],86400,true)
local list1 = faederdx1:smembers(EORO..'Tshake:Basic:Constructor'..Groups[i])
print(#list1)
for k,v in pairs(list1) do
faederdx1:sadd(EORO.."bot:monsh:"..Groups[i], v)
end
local list2 = faederdx1:smembers(EORO..'Tshake:Constructor'..Groups[i])
print(#list2)
for k,v in pairs(list2) do
faederdx1:sadd(EORO.."bot:monsh2:"..Groups[i], v)
end
local list3 = faederdx1:smembers(EORO..'Tshake:Manager'..Groups[i])
print(#list3)
for k,v in pairs(list3) do
faederdx1:sadd(EORO.."bot:owners:"..Groups[i], v)
end
local list4 = faederdx1:smembers(EORO..'Tshake:Mod:User'..Groups[i])
print(#list4)
for k,v in pairs(list4) do
faederdx1:sadd(EORO.."bot:momod:"..Groups[i], v)
end
end
for i = 1, #Users do
faederdx1:sadd(EORO..'bot:userss',Users[i])  
end
...
local Users = faederdx1:smembers(EORO..'users')
local Groups = faederdx1:smembers(EORO..'group:ids') 
for i = 1, #Groups do
faederdx1:sadd(EORO..'bot:groups',Groups[i])  
faederdx1:sadd("faeder:addg"..bot_id,Groups[i])  
faederdx1:set(EORO.."bot:enable:"..Groups[i],true)
faederdx1:setex(EORO.."bot:charge:"..Groups[i],86400,true)
local list1 = faederdx1:smembers(EORO..':MONSHA_Group:'..Groups[i])
print(#list1)
for k,v in pairs(list1) do
faederdx1:sadd(EORO.."bot:monsh:"..Groups[i], v)
end
local list2 = faederdx1:smembers(EORO..':MONSHA_BOT:'..Groups[i])
print(#list2)
for k,v in pairs(list2) do
faederdx1:sadd(EORO.."bot:monsh2:"..Groups[i], v)
end
local list3 = faederdx1:smembers(EORO..'owners:'..Groups[i])
print(#list3)
for k,v in pairs(list3) do
faederdx1:sadd(EORO.."bot:owners:"..Groups[i], v)
end
local list4 = faederdx1:smembers(EORO..'owners:'..Groups[i])
print(#list4)
for k,v in pairs(list4) do
faederdx1:sadd(EORO.."bot:momod:"..Groups[i], v)
end
...
if not faederdx1:get(EORO..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙انت منشئ المجموعه .', 1, 'md')
return false
end
local Added_Me = faederdx1:get(EORO.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
faederdx1:set(EORO..'faeder3',CH_BOT)
faederdx(msg.chat_id_,msg.id_, 1, "⌯︙تم حفظ القناة ، \n⌯︙قم بتفعيل الاشتراك الاجباري الان ، \n", 1 , "html")
return false
end
--     By Developer EORO     -- 
if faederdx1:get(EORO.."bot:nerkh" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
faederdx1:del(EORO.."bot:nerkh" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
local nerkh = msg.content_.text_:match("(.*)")
faederdx1:set(EORO.."nerkh", nerkh)
...
--     By Developer EORO     -- 
if faederdx1:get(EORO..'bot:cmds'..msg.chat_id_) and not is_momod(msg.sender_user_id_, msg.chat_id_) then
print("Return False [Lock] [Cmd]")
else  
--     By Developer EORO     -- 
 if text:match("^الرابط$") and faeder11(msg) then
if not faederdx1:get(EORO.."bot:tt:link:"..msg.chat_id_) then 
local link = faederdx1:get(EORO.."bot:group:link"..msg.chat_id_)
if link then
...
local rules = faederdx1:get(EORO..'bot:rules'..msg.chat_id_)
if rules then
...
faederdx1:set(EORO..'nsba'..msg.chat_id_..msg.sender_user_id_,'Check')
faeder = '⌯︙ارسل اسمك واسم الشخص الاخر ،\n⌯︙مثال :- فايدر وفايدره ، '
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md')
end
if text and text ~="نسبه الحب"  and faederdx1:get(EORO..'nsba'..msg.chat_id_..msg.sender_user_id_) == 'Check' then
...
faederdx1:del(EORO..'nsba'..msg.chat_id_..msg.sender_user_id_)
end
--     By Developer EORO     --
...
if faederdx1:get(EORO..'Zrf:add'..msg.chat_id_..''..msg.sender_user_id_) then 
if text == 'الغاء' then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء امر الزخرفه ،', 1, 'md')
faederdx1:del(EORO..'Zrf:add'..msg.chat_id_..''..msg.sender_user_id_)
return false  
end 
...
faederdx1:setex(EORO.."Zrf:add"..msg.chat_id_..""..msg.sender_user_id_,10000,true)
...
--     By Developer EORO     -- 
if text == 'دي' or text == 'ديي' or text == 'دي بابه' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then local faeder = { "آخـلُِآقٌڪ آلُِعٍآر 😐✨","أتجاوزكك بسرعتي أمريي لله 🙁🙌🏾"}  faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
if text == 'السلام عليكم' or text == 'سلام عليكم' or text == 'سلام'  then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "شبيكك حياتيي 🥺💘" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "شبّيي الحلو 😿💔" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "توككل بس خلصنةه 🌝😂" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then local faeder = {  "اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,  "هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
if text == 'شونك' or text == 'شونج' or text == 'شلونك' or text == 'شلونج' or text == 'شونكم' or text == 'شلونكم' or text == 'شلخبار' or text == 'شلون الاخبار' or text == 'شخبارك' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then  local faeder = {  "ني زينن وانت يعمريي 🥺💘" ,  "ماشيهه يعمري 😻💘",  "تمامم عمرري وانتت 🤤💘", } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end end
if text == 'وينك' or text == 'وينج' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "مْوٌجہوٌدِ يہمْگُ يحلوُ  😉♥️" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'بوت ملطلط' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "ربي صبرني 😞🌾" else  faeder = '' end  faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'نايمين' or text == 'ميتين' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "ني سهران احرسكمم 😻🍃" else  faeder = '' end  faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'هلوباي' or text == 'هلو باي' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "رايحح لو جايي ، 😻😹" else  faeder = '' end  faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ  😉♥️" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'فرخ' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ ، 😹♥️" else  faeder = '' end  faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end
if text == 'سورس فايدر' or text == 'سورس ديف فايدر' or text == 'سورس انور'  then if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then faeder =  "تااج وباجج حبيي ، 😹🌝" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end 
if text == 'احبك' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then local faeder = { "ٰجذابةه تريدد تقطكك  ، 😹??","ءني هم احبكك يعمري ، ☹️💘" } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
if text == 'احبج' then  if not faederdx1:get(EORO..'bot:rep:mute'..msg.chat_id_) then local faeder =  { "ٰجذابب يريد يطككج ، 😹💘","ااخ بسس اموتت بيكك ، 🥺💘" } faederdx12 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faederdx12] , 1, 'md') end end
...
if tonumber((faederdx1:get(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
faeder0 = '⌯︙ليس لديك نقاط العب اولا ، \n⌯︙للعب ارسل { الالعاب } .'
faederdx(msg.chat_id_, msg.id_, 1,faeder0, 1, 'md')
else
faeder = '⌯︙لديك ('..(faederdx1:get(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_))..') نقطه ،'
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md')
end end
--     By Developer EORO     -- 
...
if faederdx1:get(EORO..'bot:lock_geam'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙الالعاب معطله من قبل الادمن \n⌯︙ارسل { تفعيل اللعبه } لتفعيلها ', 1, 'md')
return "faeder"
end
faederdx1:del(EORO..'bot:l:ids'..msg.chat_id_)
faeder2 = {'🍏','🍎','🍐','🍊','🍋','??','🍉','🍇','🍓','🍈','??','🍑','🍍','??','🥝','🍅','🍆','🥑','🥦','??','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🧼','🎻','🎸','??','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','🩸','🎗','🏵','🎖','??','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:klmos'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:klmos'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:ids'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:ids'..msg.chat_id_) then 
faeder = '⌯︙مبروك لقد ربحت ،\n⌯︙للعب مره اخرى ارسل سمايلات . '
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md')
faederdx1:incrby(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
end
faederdx1:set(EORO..'bot:l:ids'..msg.chat_id_,true)
end
--     By Developer EORO     -- 
...
faederdx1:del(EORO..'bot:l:id'..msg.chat_id_)
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:klmo'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:klmo'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
faeder = '⌯︙مبروك لقد ربحت ،\n⌯︙للعب مره اخرى ارسل ترتيب . '
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md')
faederdx1:incrby(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
end
faederdx1:set(EORO..'bot:l:id'..msg.chat_id_,true)
end
--     By Developer EORO     -- 
...
Num = math.random(1,6)
faederdx1:set(EORO.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
faederdx1:setex(EORO.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk2'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk2'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk3'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk3'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk4'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk4'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk5'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk5'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk6'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk6'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
name = faeder2[math.random(#faeder2)]
faederdx1:set(EORO..'bot:bkbk7'..msg.chat_id_,name)
...
if text == ''..(faederdx1:get(EORO..'bot:bkbk7'..msg.chat_id_) or 'لفاتع')..'' and not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then
if not faederdx1:get(EORO..'bot:l:id'..msg.chat_id_) then 
...
--     By Developer EORO     -- 
if faederdx1:get(EORO.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
faederdx(msg.chat_id_, msg.id_, 1,"⌯︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = faederdx1:get(EORO.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
faederdx1:del(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
faederdx1:del(EORO.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
faederdx1:incrby(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_,5)  
faederdx(msg.chat_id_, msg.id_, 1,'*⌯︙التخمين الصحيح هو* ~ '..NUM..'\n*⌯︙مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
faederdx1:incrby(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(faederdx1:get(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
faederdx1:del(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
faederdx1:del(EORO.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
faederdx(msg.chat_id_, msg.id_, 1,'*⌯︙التخمين الصحيح هو*  '..GETNUM..'\n*⌯︙للاسف لقد خسرت حاول مره اخرى\n⌯︙للعب مره اخره ارسل ( تخمين )*', 1, 'md')
else
if tonumber(faederdx1:get(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(faederdx1:get(EORO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
faederdx1:set(EORO.."GAMES:NUM"..msg.chat_id_,Num) 
...
faederdx1:setex(EORO.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
--     By Developer EORO     -- 
...
faederdx1:set(EORO.."FAEDER_OO0" .. msg.chat_id_, dx1[2])
return false end
--     By Developer EORO     -- 
...
faeder0 = (faederdx1:get(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(faederdx1:get('faeder:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
faederdx1:incrby('faeder:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,faeder0)  
faederdx1:del(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_)
...
faederdx1:setex(EORO..'faeder4'..msg.sender_user_id_,300,true)
...
local faeder5 = faederdx1:get(EORO.."faeder3")
if faeder5 then
...
faederdx1:sadd(EORO..'bot:muted:'..msg.chat_id_, msg.sender_user_id_)
else
...
local msg = data.message_
text = msg.content_.text_ 
if not faederdx1:get(EORO..'TFF'..msg.chat_id_) then
...
dl_cb, nil)
faederdx1:set(EORO.."HM:"..msg.chat_id_..msg.id_..res2.id_,faed_dx[1])
...
faederdx1:del(EORO.."bot:sudo3:add"..msg.chat_id_)
faederdx1:del(EORO.."bot:monsh:add"..msg.chat_id_)
faederdx1:del(EORO.."bot:monsh2"..msg.chat_id_)
faederdx1:del(EORO.."bot:owner:add"..msg.chat_id_)
faederdx1:del(EORO.."bot:momod:add"..msg.chat_id_)
faederdx1:del(EORO.."bot:vepmem:add"..msg.chat_id_)
faederdx1:del(EORO.."bot:member:add"..msg.chat_id_)
end
--     By Developer EORO     -- 
...
if faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if faederdx1:sismember(EORO..'bot:gban:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if faederdx1:sismember(EORO..'bot:mutedall:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if faederdx1:sismember(EORO..'tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if faederdx1:sismember(EORO..'bot:gban:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if faederdx1:sismember(EORO..'bot:mutedall:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if faederdx1:sismember(EORO..'tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙الحظر : '..banned..'\n⌯︙الكتم : '..muted..'\n⌯︙التقيد : '..tkeed..'\n⌯︙الحظر العام : '..banall..'\n⌯︙الكتم العام : '..muteall..'', 1, 'md')
else
...
faederdx1:srem(EORO..'tkeed:'..msg.chat_id_,result.sender_user_id_) faederdx1:srem(EORO..'bot:banned:'..msg.chat_id_,result.sender_user_id_) faederdx1:srem(EORO..'bot:muted:'..msg.chat_id_,result.sender_user_id_)   
end
...
faederdx1:srem(EORO..'tkeed:'..msg.chat_id_,user) faederdx1:srem(EORO..'bot:banned:'..msg.chat_id_,user) faederdx1:srem(EORO..'bot:muted:'..msg.chat_id_,user)   
end,nil)  
end
...
faederdx1:srem(EORO..'tkeed:'..msg.chat_id_,result.id_) faederdx1:srem(EORO..'bot:banned:'..msg.chat_id_,result.id_) faederdx1:srem(EORO..'bot:muted:'..msg.chat_id_,result.id_)   
end,nil)   
end  
...
faederdx1:set(EORO.."UnKedDeleteMessage"..msg.chat_id_,"close") 
end
if text == 'تفعيل تنبيه الدخول' and is_owner(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙ تفعيل تنبيه الدخول ،', 'md')
faederdx1:set(EORO.."UnKedDeleteMessage"..msg.chat_id_,"open") 
end
--     By Developer EORO     -- 
if text and text == 'تفعيل وضع حسابي' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then
if not faederdx1:get(EORO..'bot:pubgacuount'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم تفعيل وضع حسابي سابقا ،', 'md')  
else
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم تفعيل وضع حسابي ،', 'md')
faederdx1:del(EORO..'bot:pubgacuount'..msg.chat_id_)
end end
if text and text == 'تعطيل وضع حسابي' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then
if faederdx1:get(EORO..'bot:pubgacuount'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم تعطيل وضع حسابي سابقا ،', 'md') 
else
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم تعطيل وضع حسابي ،', 'md')
faederdx1:set(EORO..'bot:pubgacuount'..msg.chat_id_,true)
end end
--     By Developer EORO     -- 
  if not faederdx1:get(EORO..'bot:pubgacuount'..msg.chat_id_) then
if (text and text == 'وضع حسابي') and faeder11(msg) then
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙ارسل لي اسم حسابك ،  ', 'html')
faederdx1:set(EORO..'bot:n1'..msg.sender_user_id_..'','yes')
return false end 
local Faeder = faederdx1:get(EORO..'bot:n1'..msg.sender_user_id_)
if Faeder == 'yes' then
if text:match("^(.*)$") then
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم حفظ الاسم . ✔️\n⌯︙ارسل ايدي حسابك ،\n  ', 'md')
faederdx1:set(EORO..'bot:n1'..msg.sender_user_id_..'','no')
faederdx1:set(EORO..'bot:name_acount'..msg.sender_user_id_, text)
faederdx1:set(EORO..'bot:n2'..msg.sender_user_id_ ,'yes')
return false end
end 
local Faeder = faederdx1:get(EORO..'bot:n2'..msg.sender_user_id_)
if Faeder == 'yes' then
if text:match("^(%d+)$") then
faederdx1:set(EORO..'bot:idacount'..msg.sender_user_id_, text)
faederdx1:set(EORO..'bot:n2'..msg.sender_user_id_, 'no')
local aa = [[
⌯︙تم حفظ ايديك ✅
...
faederdx1:set(EORO..'bot:n3'..msg.sender_user_id_, 'yes')
return false 
else 
return false end
end 
local Faeder = faederdx1:get(EORO..'bot:n3'..msg.sender_user_id_)
if Faeder == 'yes' then
...
faederdx1:set(EORO..'bot:n3'..msg.sender_user_id_, 'no')
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم حفظ التقييم ،\n⌯︙تم حفظ حسابك بالبوت ،\n  ', 'md')
faederdx1:set(EORO..'bot:acctear'..msg.sender_user_id_, text)
return false 
else 
...
faederdx1:del(EORO..'bot:idacount'..msg.sender_user_id_)
faederdx1:del(EORO..'bot:acctear'..msg.sender_user_id_)
faederdx1:del(EORO..'bot:name_acount'..msg.sender_user_id_)
faederdx(msg.chat_id_, msg.id_, 1,'\n⌯︙تم مسح حسابك من البوت ، ✔️ ', 'html')
end
--     By Developer EORO     -- 
if (text and text == 'حسابي') and faeder11(msg) then
if faederdx1:get(EORO..'bot:idacount'..msg.sender_user_id_)then
local n = faederdx1:get(EORO..'bot:idacount'..msg.sender_user_id_)
local nn = faederdx1:get(EORO..'bot:acctear'..msg.sender_user_id_)
local nnn = faederdx1:get(EORO..'bot:name_acount'..msg.sender_user_id_)
local Texting = {
'ككفو ورمبي ☹️💞',
"تقييمك مصعده كمبره ؟ 😉💞",
...
local faeder = faederdx1:get(EORO..'user:msgs'..bot_id..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local msguser = tonumber(faederdx1:get(EORO..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = faederdx1:get(EORO..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(faederdx1:get(EORO..'bot:user:add'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(faederdx1:get(EORO..'bot:add:num'..msg.chat_id_..msg.sender_user_id_) or 0)
local text = (tonumber(faederdx1:get(EORO.."text:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
local sticker = (tonumber(faederdx1:get(EORO.."sticker:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
local Photo = (tonumber(faederdx1:get(EORO.."Photo:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
local Voice = (tonumber(faederdx1:get(EORO.."Voice:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
local Gif = (tonumber(faederdx1:get(EORO.."Gif:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
local Video = (tonumber(faederdx1:get(EORO.."Video:"..msg.sender_user_id_..":"..msg.chat_id_.."")) or "0" )
function formsgg(msgs) 
local faeder = ''  
if msgs < 100 then 
faeder = 'صنم' 
...
local user_info_ = faederdx1:get(EORO..'user:Name' .. result.sender_user_id_)
...
function faeder(extra,result,success)
local listgp = faederdx1:smembers(EORO.."bot:groups")
for k,v in pairs(listgp) do
forwardMessages(v, msg.chat_id_, {[0] = result.id_}, 1)
end
local listpv = faederdx1:smembers(EORO.."bot:userss")
for k,v in pairs(listpv) do
forwardMessages(v, msg.chat_id_, {[0] = result.id_}, 1)
end end
local gps = faederdx1:scard(EORO..'bot:groups') or 0
local pvs = faederdx1:scard(EORO..'bot:userss') or 0
...
faederdx1:set(EORO..'bot:viewget'..msg.sender_user_id_,true)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙ارسل لي المنشور الان ، ', 1, 'md')
end
--     By Developer EORO     -- 
if text:match("^اطردني$") and faeder11(msg) then
if not faederdx1:get(EORO.."lock_kickme"..msg.chat_id_) then
faederdx1:set(EORO..'yes'..msg.sender_user_id_..'', 'kickyes')
faederdx1:set(EORO..'no'..msg.sender_user_id_..'', 'kickno')
...
local kickme = faederdx1:get(EORO..'yes'..msg.sender_user_id_..'')
...
if kickme == 'kickyes' then
chat_kick(msg.chat_id_, msg.sender_user_id_)
faederdx1:del(EORO..'yes'..msg.sender_user_id_..'', 'kickyes')
faederdx1:del(EORO..'no'..msg.sender_user_id_..'', 'kickno')
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم طردك عزيزي ،", 1, "md")
end end end
if text:match("^لا$") then
local notkickme = faederdx1:get(EORO..'no'..msg.sender_user_id_..'')
...
if not faederdx1:get(EORO.."lock_kickme"..msg.chat_id_) then
faederdx1:set(EORO.."lock_kickme"..msg.chat_id_, true)
...
if faederdx1:get(EORO.."lock_kickme"..msg.chat_id_) then
faederdx1:del(EORO.."lock_kickme"..msg.chat_id_)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم تفعيل امر اطردني ، ', 1, 'md')
end end
--     By Developer EORO     -- 
if text:match("^نزلني$") and faeder11(msg) then
if not faederdx1:get(EORO.."lock_delme"..msg.chat_id_) then
faederdx1:set(EORO..'yesdel'..msg.sender_user_id_..'', 'delyes')
faederdx1:set(EORO..'nodel'..msg.sender_user_id_..'', 'delno')
...
local delme = faederdx1:get(EORO..'yesdel'..msg.sender_user_id_..'')
if delme == 'delyes' then
if text:match("^نعم$") then
local delme = faederdx1:get(EORO..'yesdel'..msg.sender_user_id_..'')
if delme == 'delyes' then
if faederdx1:sismember(EORO..'bot:monsh:'..msg.chat_id_, msg.sender_user_id_) then
monsh = 'المنشئين الاساسيين ، ' else monsh = '' end 
if faederdx1:sismember(EORO..'bot:monsh2:'..msg.chat_id_, msg.sender_user_id_) then
monsh2 = 'المنشئين ، ' else monsh2 = '' end 
if faederdx1:sismember(EORO..'bot:owners:'..msg.chat_id_, msg.sender_user_id_) then
owner = 'المدراء ، ' else owner = '' end
if faederdx1:sismember(EORO..'bot:momod:'..msg.chat_id_, msg.sender_user_id_) then
momod = 'الادمنيه ، ' else momod = '' end
if faederdx1:sismember(EORO..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_) then
vipmem = 'المميزين ، ' else vipmem = '' end
if faederdx1:sismember(EORO..'bot:donky:'..msg.chat_id_, msg.sender_user_id_) then
donky = 'المطايه ، ' else donky = '' end 
if faederdx1:sismember(EORO..'bot:monsh:'..msg.chat_id_, msg.sender_user_id_) or faederdx1:sismember(EORO..'bot:owners:'..msg.chat_id_, msg.sender_user_id_) or faederdx1:sismember(EORO..'bot:momod:'..msg.chat_id_, msg.sender_user_id_) or faederdx1:sismember(EORO..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_) or faederdx1:sismember(EORO..'bot:donky:'..msg.chat_id_, msg.sender_user_id_) then
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,msg.sender_user_id_)
faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,msg.sender_user_id_)
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_,msg.sender_user_id_)
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_,msg.sender_user_id_)
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_,msg.sender_user_id_)
faederdx1:srem(EORO..'bot:donky:'..msg.chat_id_,msg.sender_user_id_) 
faederdx1:del(EORO..'yesdel'..msg.sender_user_id_..'', 'delyes') 
faederdx1:del(EORO..'nodel'..msg.sender_user_id_..'', 'delno')
...
if text:match("^لا$") then
local notdelme = faederdx1:get(EORO..'nodel'..msg.sender_user_id_..'')
...
if not faederdx1:get(EORO.."lock_delme"..msg.chat_id_) then
faederdx1:set(EORO.."lock_delme"..msg.chat_id_, true)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تعطيل امر نزلني ،', 1, 'md')
end end
if text == 'تفعيل نزلني' and is_monsh(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then
if faederdx1:get(EORO.."lock_delme"..msg.chat_id_) then
faederdx1:del(EORO.."lock_delme"..msg.chat_id_)
...
{text="- مبرمج السورس،",url="t.me/S_X_X_G "}},
...
add = (tonumber(faederdx1:get(EORO..'bot:user:add'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if faederdx1:sismember(EORO.."bot:monsh:"..msg.chat_id_,result.id_) then
...
if faederdx1:sismember(EORO.."bot:monsh:"..msg.chat_id_,result.sender_user_id_) then
faederdx(msg.chat_id_, msg.id_, 1, 'دي لك تريد اهين تاج راسك المنشئ ؟ 🌚🙆', 1, 'md') 
return false
end 
local faeder = "صار ستاذي 💞🏃" 
...
if tonumber(result.sender_user_id_) == tonumber(bot_owner) then  
faederdx(msg.chat_id_, msg.id_, 1, 'مواححح احلى بوسةه المطوري😻🔥💗 @'.. SudoEORO, 1, 'html')
return false
end 
local faeder = "صار ستاذي 💞🏃" 
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md') 
...
faederdx1:sadd(EORO..'bot:admins:',result.sender_user_id_)
...
if result.id_ then
faederdx1:sadd(EORO..'bot:admins:',result.id_)
...
faederdx1:srem(EORO..'bot:admins:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:admins:',result.id_)
...
faederdx1:sadd(EORO..'bot:onall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:sadd(EORO..'bot:onall:',result.id_)
...
function prom_reply(extra, result, success)
faederdx1:srem(EORO..'bot:onall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:onall:',result.id_)
...
function raf_reply(extra, result, success)
faederdx1:sadd(EORO..'bot:moall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:sadd(EORO..'bot:moall:',result.id_)
...
function prom_reply(extra, result, success)
faederdx1:srem(EORO..'bot:moall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:moall:',result.id_)
...
function raf_reply(extra, result, success)
faederdx1:sadd(EORO..'bot:vpall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:sadd(EORO..'bot:vpall:',result.id_)
...
function prom_reply(extra, result, success)
faederdx1:srem(EORO..'bot:vpall:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:vpall:',result.id_)
...
function raf_reply(extra, result, success)
faederdx1:sadd(EORO..'bot:monsh:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:sadd(EORO..'bot:monsh:'..msg.chat_id_,result.id_)
...
function prom_reply(extra, result, success)
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.id_)
...
function raf_reply(extra, result, success)
faederdx1:sadd(EORO..'bot:monsh2:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:sadd(EORO..'bot:monsh2:'..msg.chat_id_,result.id_)
...
function prom_reply(extra, result, success)
faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.id_)
...
if faederdx1:sismember(EORO..'bot:admins:',result.sender_user_id_) then
sudo3 = 'مطور ثالث ، ' else sudo3 = '' end
if faederdx1:sismember(EORO..'bot:onall:',result.sender_user_id_) then
onall = 'مدير عام ، ' else onall = '' end
if faederdx1:sismember(EORO..'bot:moall:',result.sender_user_id_) then
moall = 'ادمن عام ، ' else moall = '' end
if faederdx1:sismember(EORO..'bot:vpall:',result.sender_user_id_) then
vpall = 'مميز عام ، ' else vpall = '' end
if faederdx1:sismember(EORO..'bot:monsh:'..msg.chat_id_, result.sender_user_id_) then
monsh = 'منشئ اساسي ،  ' else monsh = '' end
if faederdx1:sismember(EORO..'bot:monsh2:'..msg.chat_id_, result.sender_user_id_) then
monsh2 = 'منشئ ، ' else monsh2 = '' end 
if faederdx1:sismember(EORO..'bot:owners:'..msg.chat_id_, result.sender_user_id_) then
owner = 'مدير ، ' else owner = '' end
if faederdx1:sismember(EORO..'bot:momod:'..msg.chat_id_, result.sender_user_id_) then
momod = 'ادمن ، ' else momod = '' end
if faederdx1:sismember(EORO..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_) then
...
faederdx1:srem(EORO..'bot:admins:', result.sender_user_id_) faederdx1:srem(EORO..'bot:onall:', result.sender_user_id_) 
faederdx1:srem(EORO..'bot:moall:', result.sender_user_id_) faederdx1:srem(EORO..'bot:vpall:', result.sender_user_id_)
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.sender_user_id_) faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.sender_user_id_) 
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.sender_user_id_) faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.sender_user_id_)
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_)
elseif fadx(msg.sender_user_id_,msg.chat_id_) == 'sudo3' then
faederdx1:srem(EORO..'bot:onall:', result.sender_user_id_) faederdx1:srem(EORO..'bot:moall:', result.sender_user_id_) faederdx1:srem(EORO..'bot:vpall:', result.sender_user_id_)
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.sender_user_id_) faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_) 
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.sender_user_id_)  faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.sender_user_id_) 
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.sender_user_id_)
...
if faederdx1:sismember(EORO..'bot:admins:',result.id_) then
sudo3 = 'مطور ثالث ، ' else sudo3 = '' end
if faederdx1:sismember(EORO..'bot:onall:',result.id_) then
onall = 'مدير عام ، ' else onall = '' end
if faederdx1:sismember(EORO..'bot:moall:',result.id_) then
moall = 'ادمن عام ، ' else moall = '' end
if faederdx1:sismember(EORO..'bot:vpall:',result.id_) then
vpall = 'مميز عام ، ' else vpall = '' end
if faederdx1:sismember(EORO..'bot:monsh:'..msg.chat_id_, result.id_) then
monsh = 'منشئ اساسي ،  ' else monsh = '' end
if faederdx1:sismember(EORO..'bot:monsh2:'..msg.chat_id_, result.id_) then
monsh2 = 'منشئ ، ' else monsh2 = '' end 
if faederdx1:sismember(EORO..'bot:owners:'..msg.chat_id_, result.id_) then
owner = 'مدير ، ' else owner = '' end
if faederdx1:sismember(EORO..'bot:momod:'..msg.chat_id_, result.id_) then
momod = 'ادمن ، ' else momod = '' end
if faederdx1:sismember(EORO..'bot:vipmem:'..msg.chat_id_, result.id_) then
vipmem = 'مميز' else vipmem = ''
end
...
if fadx(msg.sender_user_id_,msg.chat_id_) == 'botow' then
faederdx1:srem(EORO..'bot:admins:', result.id_) faederdx1:srem(EORO..'bot:onall:', result.id_)
faederdx1:srem(EORO..'bot:moall:', result.id_) faederdx1:srem(EORO..'bot:vpall:', result.id_)
faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.id_) faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.id_)
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.id_) faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.id_)
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.id_)
elseif fadx(msg.sender_user_id_,msg.chat_id_) == 'sudo3' then
faederdx1:srem(EORO..'bot:onall:', result.id_) faederdx1:srem(EORO..'bot:moall:', result.id_)
faederdx1:srem(EORO..'bot:vpall:', result.id_) faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.id_)
faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.id_) faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.id_)
faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.id_) faederdx1:srem(EORO..'bot:monsh:'..msg.chat_id_,result.id_)
elseif fadx(msg.sender_user_id_,msg.chat_id_) == 'monsh' then
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.id_) faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.id_)
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.id_) faederdx1:srem(EORO..'bot:monsh2:'..msg.chat_id_,result.id_)
elseif fadx(msg.sender_user_id_,msg.chat_id_) == 'monsh2' then
faederdx1:srem(EORO..'bot:momod:'..msg.chat_id_, result.id_) faederdx1:srem(EORO..'bot:vipmem:'..msg.chat_id_, result.id_)
faederdx1:srem(EORO..'bot:owners:'..msg.chat_id_, result.id_)
elseif fadx(msg.sender_user_id_,msg.chat_id_) == 'owner' then
...
if faederdx1:sismember(EORO..faeder, result.sender_user_id_) then
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم حظره سابقا𓍢\n")
chat_kick(result.chat_id_, result.sender_user_id_)
else
faederdx1:sadd(EORO..faeder, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم حظره بنجاح𓍢\n")
chat_kick(result.chat_id_, result.sender_user_id_)
end end end
...
if faederdx1:sismember(EORO..faeder, result.id_) then
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم حظره سابقا𓍢\n")
else
faederdx1:sadd(EORO..faeder, result.id_)
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم حظره بنجاح𓍢\n")
...
local user_info_ = faederdx1:get(EORO..'user:Name' .. res[2])
...
faederdx1:sadd(EORO..'bot:banned:'..msg.chat_id_, res[2])
...
local faeder = 'bot:banned:'..msg.chat_id_
if not faederdx1:sismember(EORO..faeder, result.sender_user_id_) then
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙لم يتم حظره سابقا𓍢\n")
else  
faederdx1:srem(EORO..faeder, result.sender_user_id_)
...
if result.id_ then
if not faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_, result.id_) then
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙لم يتم حظره سابقا𓍢\n")
else 
faederdx1:srem(EORO..'bot:banned:'..msg.chat_id_, result.id_)
...
local user_info_ = faederdx1:get(EORO..'user:Name' .. res[2])
local faeder_res = user_info_ if user_info_ then
if not faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_, res[2]) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..faeder_res..'] )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n⌯︙*لم يتم ( حظره ) سابقا*', 1, 'md')
else 
faederdx1:srem(EORO..'bot:banned:'..msg.chat_id_, res[2])
...
local gps = faederdx1:scard(EORO.."bot:groups")
...
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم حظره من "..gps.." مجموعه𓍢\n")
faederdx1:sadd(EORO..'bot:gban:', result.id_)
chat_kick(msg.chat_id_, result.id_)
end end
...
faederdx1:sadd(EORO..faeder, res[2])
chat_kick(msg.chat_id_, res[2])
end
--     By Developer EORO     -- 
...
faederdx1:srem(EORO..'bot:gban:', result.sender_user_id_)
faederdx1:srem(EORO..'bot:mutedall:', result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
end
...
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم الغاء حظره ، كتمه من "..gps.." مجموعه𓍢\n")
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)
faederdx1:srem(EORO..'bot:gban:', result.id_)
faederdx1:srem(EORO..'bot:mutedall:', result.id_)
end end 
...
faederdx1:srem(EORO..'bot:gban:', res[2])
faederdx1:srem(EORO..'bot:mutedall:', res[2])
...
faederdx1:sadd(EORO..'bot:mutedall:', result.sender_user_id_)
...
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم كتمه في "..gps.." مجموعه𓍢\n")
faederdx1:sadd(EORO..'bot:mutedall:', result.id_)
end end
...
faederdx1:sadd(EORO..'bot:mutedall:', res[2])
...
faederdx1:sadd(EORO..'bot:muted:'..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم  كتمه𓍢\n")
end end 
...
if faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_, res[2]) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..faeder_res..'] )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n⌯︙*تم  ( كتمه ) سابقا ،*', 1, 'md')
end
faederdx1:sadd(EORO..'bot:muted:'..msg.chat_id_, res[2])
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙*العضو* ( ['..faeder_res..'] )\n⌯︙*بواسطه ( '..renk_faeder(msg)..' )*\n⌯︙*تم  ( كتمه ) ،*', 1, 'md')
end end end
--     By Developer EORO     -- 
...
local user_info_ = faederdx1:get(EORO..'user:Name' .. result.id_)
local faeder_res = user_info_ 
if result.id_ then
if not faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_, result.id_) then
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙لم يتم كتمه سابقا𓍢\n")
else
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم الغاء كتمه بنجاح𓍢\n")
faederdx1:srem(EORO..'bot:muted:'..msg.chat_id_, result.id_)
end end end
...
local user_info_ = faederdx1:get(EORO..'user:Name' .. res[2])
local faeder_res = user_info_ if user_info_ then
if not faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_, res[2]) then
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙لم يتم كتمه سابقا𓍢\n")
else
faederdx1:srem(EORO..'bot:muted:'..msg.chat_id_, res[2])
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم الغاء كتمه بنجاح𓍢\n")
end end end end
--     By Developer EORO     -- 
...
if faederdx1:sismember(EORO..hash, result.sender_user_id_) then
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙هو مطي اصلا حبي 🤫😂\n")
else
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم رفعه مطي 🐴\n")
end
faederdx1:sadd(EORO..hash, result.sender_user_id_)
end end
...
if user_info_ then
local hash = 'bot:donky:'..msg.chat_id_
if not faederdx1:sismember(EORO..hash, result.sender_user_id_) then
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙لم يتم رفعه مطي\n")
else
Send_Options(msg,result.sender_user_id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙يبقه مطي بس حنزله لخاطرك 🤫😂\n")
faederdx1:srem(EORO..hash, result.sender_user_id_)
end end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     By Developer EORO     -- 
...
faederdx1:sadd(EORO..'tkeed:'..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.id_,"reply","⌯︙بواسطه ، "..renk_faeder(msg).."\n⌯︙تم تقييده بنجاح𓍢\n")
end end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,mute_by_reply)
end
...
HTTPS.request("https://api.telegram.org/bot" .. tokenbot .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
faederdx1:srem(EORO..'tkeed:'..msg.chat_id_, result.sender_user_id_)
...
faederdx1:sadd(EORO..'bot:mutet:'..msg.chat_id_,result.sender_user_id_) end end 
...
local list = faederdx1:smembers(EORO..hash)
for k,v in pairs(list) do   
HTTPS.request("https://api.telegram.org/bot" .. tokenbot .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..v.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True") 
faederdx1:srem(EORO..'tkeed:'..msg.chat_id_, v)
end
...
faederdx1:set(EORO..'pinnedmsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local list = faederdx1:smembers(EORO.."tkeed:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:momod:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:monsh2:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:moall:")
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:vipmem:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:donky:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO..'bot:vpall:')
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:muted:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:owners:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO..'bot:onall:')
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:monsh:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO.."bot:banned:"..msg.chat_id_)
if #list == 0 then
...
local list = faederdx1:smembers(EORO..'bot:gban:')
if #list == 0 then
...
local list = faederdx1:smembers(EORO..'bot:mutedall:')
if #list == 0 then
...
faederdx1:setex(EORO.."bot:support:link" .. msg.sender_user_id_, 120, true)
end
if is_sudo(msg) and (text:match("^حذف الدعم$")) then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حذف معلومات الدعم ", 1, "md")
faederdx1:del(EORO.."bot:supports:link")
end
--     By Developer EORO     -- 
...
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md') 
faederdx1:del(EORO..'bot:Convert'..msg.chat_id_) 
end
...
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md') 
faederdx1:set(EORO..'bot:Convert'..msg.chat_id_,true)  
end
if text == 'تحويل' and not faederdx1:get(EORO..'bot:Convert'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
if faederdx1:sismember(EORO..'bot:gban:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif faederdx1:sismember(EORO..'bot:mutedall:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif faederdx1:sismember(EORO..'tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = 'لا يوجد'
end
...
if faederdx1:sismember(EORO..'bot:gban:',res.id_) then
Tkeed = 'محظور عام'
elseif faederdx1:sismember(EORO..'bot:mutedall:',res.id_) then
Tkeed = 'مكتوم عام'
elseif faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif faederdx1:sismember(EORO..'tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = ' لا يوجد'
end
...
if faederdx1:sismember(EORO..'bot:gban:',iduser) then
Tkeed = 'محظور عام'
elseif faederdx1:sismember(EORO..'bot:mutedall:',iduser) then
Tkeed = 'مكتوم عام'
elseif faederdx1:sismember(EORO..'bot:banned:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif faederdx1:sismember(EORO..'bot:muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif faederdx1:sismember(EORO..'tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = ' لا يوجد'
end
...
--     By Developer EORO     -- 
 if text == "صورتي" and not faederdx1:get(EORO.."lock:get:photo"..msg.chat_id_)  and faeder11(msg) then 
local function getpro(extra, result, success)
if result.photos_[0] then
...
if not is_momod(msg.sender_user_id_, msg.chat_id_) and faederdx1:get(EORO.."lock:get:photo"..msg.chat_id_)  then 
...
if not faederdx1:get(EORO..'editmsg'..msg.chat_id_) then
...
faederdx1:set(EORO..'flood:max:'..msg.chat_id_,floodmax[2])
end end 
--     By Developer EORO     -- 
...
faederdx1:set(EORO..'floodstatus'..msg.chat_id_,'Kicked')
end end
if status[2] == "بالمسح" then
if faederdx1:get(EORO..'floodstatus'..msg.chat_id_) == "DelMsg" then
...
faederdx1:set(EORO..'floodstatus'..msg.chat_id_,'DelMsg')
end end end
--     By Developer EORO     -- 
...
faederdx1:set(EORO..'far'..msg.chat_id_,'thhhh')
end end
if status[2] == "بدون تحذير" then
if faederdx1:get(EORO..'far'..msg.chat_id_) == "bedthhh" then
...
faederdx1:set(EORO..'far'..msg.chat_id_,'bedthhh')
end end end
--     By Developer EORO     -- 
...
if not faederdx1:get(EORO..'bot:lock_geam'..msg.chat_id_) then
...
faederdx1:del(EORO..'bot:lock_geam'..msg.chat_id_)
 end end
...
faederdx1:setex(EORO.."bot:setgroup:link"..msg.chat_id_..""..msg.sender_user_id_,300,true) 
end
--     By Developer EORO     -- 
if text == "الدعم" or text == "المطور" and faeder11(msg) then
local link = faederdx1:get(EORO.."bot:supports:link")
if link then
...
faederdx1:set(EORO.."bot:welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and faeder11(msg) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم تعطيل الترحيب ، ', 1, 'md')
faederdx1:del(EORO.."bot:welcome"..msg.chat_id_)
end
if faederdx1:get(EORO..'add:welcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم الغاء حفظ الترحيب ،", 1, "md")
faederdx1:del(EORO..'add:welcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
faederdx1:del(EORO..'add:welcome'..msg.chat_id_..':'..msg.sender_user_id_)
faederdx1:set(EORO..'get:welcome'..msg.chat_id_,text)
...
faederdx1:set(EORO..'add:welcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
...
--     By Developer EORO     -- 
if faederdx1:get(EORO..'bot:addrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ القوانين ', 1, 'md')
faederdx1:del(EORO..'bot:addrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
faederdx1:del(EORO..'bot:addrules'..msg.chat_id_..':'..msg.sender_user_id_)
faederdx1:set(EORO..'bot:rules'..msg.chat_id_,text)
...
faederdx1:set(EORO..'bot:addrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if faederdx1:get(EORO..'SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم الغاء حفظ الوصف ', 1, 'md')
faederdx1:del(EORO..'SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
faederdx1:del(EORO..'SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
faederdx1:set(EORO..'SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
local hash = (EORO..'bot:filters:'..msg.chat_id_)
if not faederdx1:hget(EORO..hash, name) then
...
local gps = faederdx1:scard(EORO.."bot:groups")
local users = faederdx1:scard(EORO.."bot:userss")
local allmgs = faederdx1:get(EORO.."bot:allmsgs")
if faederdx1:get(EORO..'autoleave') == "On" then
autoleavear = "مفعل 🌟"
elseif faederdx1:get(EORO..'autoleave') == "Off" then
autoleavear = "معطل 🛢"
elseif not faederdx1:get(EORO..'autoleave') then
autoleavear = "معطل 🛢"
end
if faederdx1:get(EORO..'clerk') == "On" then
clerkar = "مفعل 🌟"
elseif faederdx1:get(EORO..'clerk') == "Off" then
clerkar = "مفعل 🛢"
elseif not faederdx1:get(EORO..'clerk') then
clerkar = "مفعل 🌟"
end
...
local group = faederdx1:smembers(EORO.."bot:groups")
local w = 0
local q = 0
for i = 1, #group do
...
faederdx1:srem(EORO.."bot:groups",group[i]) 
...
faederdx1:del(EORO.."bot:allmsgs")
...
if faederdx1:get(EORO..'editmsg'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » التعديل  \n⌯︙بواسطة ('..msg.sender_user_id_..') ' 
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'editmsg'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » التعديل سابقا ،', 1, 'md')
end end
if unlockpts[2] == "الفارسيه" then
if faederdx1:get(EORO..'farsi'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الفارسيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'farsi'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الفارسيه سابقا ،', 1, 'md')
end end
if unlockpts[2] == "الفارسيه بالطرد" then
if faederdx1:get(EORO..'farsiban'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الفارسيه بالطرد  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 63, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'farsiban'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الفارسيه بالطرد سابقا ،', 1, 'md')
end end
if unlockpts[2] == "الشارحه" then
if faederdx1:get(EORO..'bot:cmds'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الشارحه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:cmds'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الشارحه سابقا ،', 1, 'md')
end end
if unlockpts[2] == "البوتات" then
if faederdx1:get(EORO..'bot:bots:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » البوتات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:bots:mute'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » البوتات سابقا ،', 1, 'md')
end end
if unlockpts[2] == "البوتات بالطرد" then
if faederdx1:get(EORO..'bot:bots:ban'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » البوتات بالطرد  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 62, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:bots:ban'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » البوتات بالطرد سابقا ،', 1, 'md')
end end
if unlockpts[2] == "البوتات بالتقييد" then
if faederdx1:get(EORO..'keed_bots'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » البوتات بالتقييد  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 64, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'keed_bots'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » التكرار  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'anti-flood:'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » التكرار سابقا ،', 1, 'md')
end end
if unlockpts[2] == "التثبيت" then
if faederdx1:get(EORO..'bot:pin:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » التثبيت  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:pin:mute'..msg.chat_id_)
else
...
local num1 = tonumber(hour) * 3600
local num = tonumber(num1)
faederdx1:setex(EORO..'bot:muteall'..msg.chat_id_, num, true)
...
if not faederdx1:get(EORO..'bot:text:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الدردشه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:text:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الدردشه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الاونلاين" then
if not faederdx1:get(EORO..'bot:inline:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الاونلاين  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 57, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:inline:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الاونلاين سابقا ،', 1, 'md')
end end
if mutepts[2] == "الصور" then
if not faederdx1:get(EORO..'bot:photo:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الصور  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 53, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:photo:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الصور سابقا ،', 1, 'md')
end end
if mutepts[2] == "الكلايش" then
if not faederdx1:get(EORO..'bot:spam:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الكلايش  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:spam:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الكلايش سابقا ،', 1, 'md')
end end
if mutepts[2] == "الفيديو" then
if not faederdx1:get(EORO..'bot:video:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الفيديو  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:video:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الفيديو سابقا ،', 1, 'md')
end end
if mutepts[2] == "المتحركه" then
if not faederdx1:get(EORO..'bot:gifs:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » المتحركه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:gifs:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » المتحركه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الاغاني" then
if not faederdx1:get(EORO..'bot:music:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الاغاني  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:music:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الاغاني سابقا ،', 1, 'md')
end end
if mutepts[2] == "الصوت" then
if not faederdx1:get(EORO..'bot:voice:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الصوت  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 53, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:voice:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الصوت سابقا ،', 1, 'md')
end end
if mutepts[2] == "الروابط" then
if not faederdx1:get(EORO..'bot:links:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الروابط  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:links:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الروابط سابقا ،', 1, 'md')
end end
if mutepts[2] == "المواقع" then
if not faederdx1:get(EORO..'bot:location:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » المواقع  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:location:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » المواقع سابقا ،', 1, 'md')
end end
if mutepts[2] == "المعرف" then
if not faederdx1:get(EORO..'tags:lock'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » المعرف  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 51, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'tags:lock'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » المعرف سابقا ،', 1, 'md')
end end
if mutepts[2] == "الدخول" then
if not faederdx1:get(EORO..'Lock:Join'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الدخول  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'Lock:Join'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الدخول سابقا ،', 1, 'md')
end end
if  mutepts[2] == "الحمايه" then
if not faederdx1:get(EORO..'bot:strict'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الحمايه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:strict'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الحمايه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الملفات" then
if not faederdx1:get(EORO..'bot:document:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الملفات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:document:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الملفات سابقا ،', 1, 'md')
end end
if mutepts[2] == "الهاشتاك" then
if not faederdx1:get(EORO..'bot:hashtag:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الهاشتاك  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:hashtag:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الهاشتاك سابقا ،', 1, 'md')
end end
if mutepts[2] == "الجهات" then
if not faederdx1:get(EORO..'bot:contact:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الجهات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:contact:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الجهات سابقا ،', 1, 'md')
end end
if mutepts[2] == "الشبكات" then
if not faederdx1:get(EORO..'bot:webpage:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الشبكات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:webpage:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الشبكات سابقا ،', 1, 'md')
end end
if mutepts[2] == "العربيه" then
if not faederdx1:get(EORO..'bot:arabic:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » العربيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:arabic:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » العربيه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الانكليزيه" then
if not faederdx1:get(EORO..'bot:english:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الانكليزيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 58, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:english:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الانكليزيه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الملصقات" then
if not faederdx1:get(EORO..'bot:sticker:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الملصقات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:sticker:mute'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الملصقات سابقا ،', 1, 'md')
end end
if mutepts[2] == "الماركداون" then
if not faederdx1:get(EORO..'markdown:lock'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الماركداون  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 58, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'markdown:lock'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الماركداون سابقا ،', 1, 'md')
end end
if mutepts[2] == "الاشعارات" then
if not faederdx1:get(EORO..'bot:tgservice:jk'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الاشعارات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 57, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:tgservice:jk'..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الاشعارات سابقا ،', 1, 'md')
end end
if mutepts[2] == "الفشار" then
if not faederdx1:get(EORO.."fshar"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الفشار  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:set(EORO.."fshar"..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الفشار سابقا ،', 1, 'md')
end end
if mutepts[2] == "الطائفيه" then
if not faederdx1:get(EORO.."taf"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الطائفيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:set(EORO.."taf"..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الطائفيه سابقا ،', 1, 'md')
end end
if mutepts[2] == "الكفران" then
if not faederdx1:get(EORO.."kaf"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » الكفران  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO.."kaf"..msg.chat_id_,true)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم قفل » الكفران سابقا ،', 1, 'md')
end end
if mutepts[2] == "التوجيه" then
if not faederdx1:get(EORO..'bot:forward:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم قفل » التوجيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:set(EORO..'bot:forward:mute'..msg.chat_id_,true)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الدردشه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:text:mute'..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الدردشه سابقا ،', 1, 'md')
end end
if unmutepts[2] == "الفشار" then
if faederdx1:get(EORO.."fshar"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الفشار  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:del(EORO.."fshar"..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الفشار سابقا ،', 1, 'md')
end end
if unmutepts[2] == "الطائفيه" then
if faederdx1:get(EORO.."taf"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الطائفيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:del(EORO.."taf"..msg.chat_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الطائفيه سابقا ،', 1, 'md')
end end
if unmutepts[2] == "الكفران" then
if faederdx1:get(EORO.."kaf"..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الكفران  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO.."kaf"..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الصور  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 53, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:photo:mute'..msg.chat_id_)
else 
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم فتح » الصور سابقا ،', 1, 'md')
end end
if unmutepts[2] == "الكلايش" then
if faederdx1:get(EORO..'bot:spam:mute'..msg.chat_id_) then
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الكلايش  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:spam:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الفيديو  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:video:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الملفات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:document:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الاونلاين  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 57, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:inline:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الماركداون  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 58, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'markdown:lock'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » المتحركه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:gifs:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الاغاني  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:music:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الصوت  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 53, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:voice:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الروابط  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:links:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » المواقع  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:location:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » المعرف  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'tags:lock'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الدخول  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'Lock:Join'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الحمايه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:strict'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الهاشتاك  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:hashtag:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الجهات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 54, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:contact:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الشبكات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:webpage:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » العربيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:arabic:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الانكليزيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 58, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:english:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الاشعارات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 57, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:tgservice:jk'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » الملصقات  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 56, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:sticker:mute'..msg.chat_id_)
else
...
local faeder = '⌯︙رتبتك : '..tar..' \n⌯︙تم فتح » التوجيه  \n⌯︙بواسطة ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 55, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:forward:mute'..msg.chat_id_)
else 
...
faederdx1:set(EORO..'bot:sens:spam'..msg.chat_id_,sensspam[2])
...
faederdx1:del(EORO..'bot:banned:'..msg.chat_id_) 
...
faederdx1:del(EORO..'bot:momod:'..msg.chat_id_)
end
if txts[2] == 'المطايه' then
local faeder = '⌯︙تم مسح المطايه ،  \n⌯︙بواسطه ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 33, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:donky:'..msg.chat_id_)
end
...
faederdx1:del(EORO..'bot:vipmem:'..msg.chat_id_)
end
if txts[2] == 'قائمه المنع' then
local faeder = '⌯︙تم مسح قائمه المنع ،  \n⌯︙بواسطه ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 37, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:filters:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' then
faederdx1:del(EORO..'bot:muted:'..msg.chat_id_)
local faeder = '⌯︙تم مسح المكتومين ،  \n⌯︙بواسطه ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 35, string.len(msg.sender_user_id_))
end end end
if text == 'مسح الرابط' and faeder11(msg) then
faederdx1:del(EORO.."bot:group:link"..msg.chat_id_)
...
faederdx1:del(EORO..'bot:monsh:'..msg.chat_id_)
end
if txts[2] == 'الادمنيه العامين' then
local faeder = '⌯︙تم مسح الادمنيه العامين ،  \n⌯︙بواسطه ('..msg.sender_user_id_..') '
faedrmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, faeder, 42, string.len(msg.sender_user_id_))
faederdx1:del(EORO..'bot:moall:')
end
...
faederdx1:set(EORO..'bot:links:mute'..msg.chat_id_,true)
faederdx1:set(EORO..'bot:forward:mute'..msg.chat_id_,true)
faederdx1:del(EORO..'lock:get:photo'..msg.chat_id_)
faederdx1:set(EORO..'bot:bots:ban'..msg.chat_id_,true)
faederdx1:set(EORO..'anti-flood:'..msg.chat_id_,true)
faederdx1:set(EORO..'bot:video:mute'..msg.chat_id_,true)
faederdx1:set(EORO..'bot:gifs:mute'..msg.chat_id_,true)
...
if faederdx1:get(EORO..'farsi'..msg.chat_id_) then mute_farsi = 'مفعل ✔️' else mute_farsi = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'farsiban'..msg.chat_id_) then mute_farsiban = 'مفعل ✔️' else mute_farsiban = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:bots:ban'..msg.chat_id_) then mute_botsban = 'مفعل ✔️' else mute_botsban = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'keed_bots'..msg.chat_id_) then mute_botske = 'مفعل ✔️' else mute_botske = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO.."fshar"..msg.chat_id_) then mute_fshar = 'مفعل ✔️' else mute_fshar = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO.."taf"..msg.chat_id_) then mute_taf = 'مفعل ✔️' else mute_taf = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO.."kaf"..msg.chat_id_) then mute_kaf = 'مفعل ✔️' else mute_kaf = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:muteall'..msg.chat_id_) then mute_all = 'مفعل ✔️' else mute_all = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:text:mute'..msg.chat_id_) then mute_text = 'مفعل ✔️' else mute_text = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:photo:mute'..msg.chat_id_) then mute_photo = 'مفعل ✔️' else mute_photo = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:video:mute'..msg.chat_id_) then mute_video = 'مفعل ✔️' else mute_video = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:gifs:mute'..msg.chat_id_) then mute_gifs = 'مفعل ✔️' else mute_gifs = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'anti-flood:'..msg.chat_id_) then mute_flood = 'مفعل ✔️' else mute_flood = 'معطل ✖️' end
------------faeder
if not faederdx1:get(EORO..'flood:max:'..msg.chat_id_) then
flood_m = 5 else
flood_m = faederdx1:get(EORO..'flood:max:'..msg.chat_id_) end
------------faeder
if not faederdx1:get(EORO..'bot:sens:spam'..msg.chat_id_) then
spam_c = 250 else
spam_c = faederdx1:get(EORO..'bot:sens:spam'..msg.chat_id_) end
------------faeder
if faederdx1:get(EORO..'floodstatus'..msg.chat_id_) == "DelMsg" then
floodstatus = "بالمسح"
elseif faederdx1:get(EORO..'floodstatus'..msg.chat_id_) == "Kicked" then
floodstatus = "بالطرد"
elseif not faederdx1:get(EORO..'floodstatus'..msg.chat_id_) then
floodstatus = "بالمسح" end
------------faeder
if faederdx1:get(EORO..'bot:music:mute'..msg.chat_id_) then mute_music = 'مفعل ✔️' else mute_music = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:bots:ban'..msg.chat_id_) then mute_bots = 'مفعل ✔️' else mute_bots = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:inline:mute'..msg.chat_id_) then mute_in = 'مفعل ✔️' else mute_in = 'معطل ✖️' end
------------faeder 
if faederdx1:get(EORO..'bot:cmds'..msg.chat_id_) then mute_cmd = 'مفعل ✔️' else mute_cmd = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:voice:mute'..msg.chat_id_) then mute_voice = 'مفعل ✔️' else mute_voice = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'editmsg'..msg.chat_id_) then mute_edit = 'مفعل ✔️' else mute_edit = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:links:mute'..msg.chat_id_) then mute_links = 'مفعل ✔️' else mute_links = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:pin:mute'..msg.chat_id_) then lock_pin = 'مفعل ✔️' else lock_pin = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:sticker:mute'..msg.chat_id_) then lock_sticker = 'مفعل ✔️' else lock_sticker = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:tgservice:jk'..msg.chat_id_) then lock_tgservice = 'مفعل ✔️' else lock_tgservice = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:webpage:mute'..msg.chat_id_) then lock_wp = 'مفعل ✔️' else lock_wp = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:strict'..msg.chat_id_) then strict = 'مفعل ✔️' else strict = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:hashtag:mute'..msg.chat_id_) then lock_htag = 'مفعل ✔️' else lock_htag = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'tags:lock'..msg.chat_id_) then lock_tag = 'مفعل ✔️' else lock_tag = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:location:mute'..msg.chat_id_) then lock_location = 'مفعل ✔️' else lock_location = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:contact:mute'..msg.chat_id_) then lock_contact = 'مفعل ✔️' else lock_contact = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:english:mute'..msg.chat_id_) then lock_english = 'مفعل ✔️' else lock_english = 'معطل ✖️' end
------------fader
if faederdx1:get(EORO..'bot:arabic:mute'..msg.chat_id_) then lock_arabic = 'مفعل ✔️' else lock_arabic = 'معطل ✖️' end
------------fader
if faederdx1:get(EORO..'bot:forward:mute'..msg.chat_id_) then lock_forward = 'مفعل ✔️' else lock_forward = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:document:mute'..msg.chat_id_) then lock_file = 'مفعل ✔️' else lock_file = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'markdown:lock'..msg.chat_id_) then markdown = 'مفعل ✔️' else markdown = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO..'bot:spam:mute'..msg.chat_id_) then lock_spam = 'مفعل ✔️' else lock_spam = 'معطل ✖️' end
------------faeder
if faederdx1:get(EORO.."bot:welcome"..msg.chat_id_) then send_welcome = 'مفعل ✔️' else send_welcome = 'معطل ✖️' end
------------faeder
...
local note = faederdx1:get(EORO..'owner:note1')
...
faederdx1:set(EORO..'bot:setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     By Developer EORO     -- 
...
function faeder(f1,f2)
function faeder333(t1,t2)
local list = faederdx1:smembers(EORO.."bot:monsh:" .. chattid)
if list[1] or list[2] or list[3] or list[4] then
user_info = faederdx1:get(EORO.."user:Name" .. (list[1] or list[2] or list[3] or list[4]))
end
if user_info then
monsh = user_info
else
...
local Monsh = faederdx1:scard(EORO.."bot:monsh:" .. chattid) or "0"
local Baned = faederdx1:scard(EORO.."bot:banned:" .. chattid) or "0"
local Owner = faederdx1:scard(EORO.."bot:owners:" .. chattid) or "0"
local Muted = faederdx1:scard(EORO.."bot:muted:" .. chattid) or "0"
local Tkeed = faederdx1:scard(EORO.."bot:keed:" .. chattid) or "0"
local Momod = faederdx1:scard(EORO.."bot:momod:" .. chattid) or "0"
local Vip = faederdx1:scard(EORO.."bot:vipmem:" .. chattid) or "0"
if t2.invite_link_ == false then 
local getlink = 'https://api.telegram.org/bot'..tokenbot..'/exportChatInviteLink?chat_id='..msg.chat_id_
local req = https.request(getlink)
local link = json:decode(req)
...
faederdx1:set(EORO.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@Faeder_ch")) 
...
if not faederdx1:get(EORO..'lock:add'..msg.chat_id_) then
...
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تفعيل منو ضافني'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:del(EORO..'Added:Me'..msg.chat_id_) 
end
if text == 'تعطيل ضافني' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تعطيل منو ضافني'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:set(EORO..'Added:Me'..msg.chat_id_,true)  
end
--     By Developer EORO     -- 
if text == 'تفعيل البوت الخدمي' then 
local  faeder = '⌯︙تم تفعيل البوت الخدمي ' 
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:del(EORO..'lock:bot:free'..bot_id) 
end
if text == 'تعطيل البوت الخدمي' then 
faeder = '⌯︙تم تعطيل البوت الخدمي ' 
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:set(EORO..'lock:bot:free'..bot_id,true) 
end
--     By Developer EORO     -- 
...
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:del(EORO..'lock:bot:ttt'..bot_id) 
end end
...
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:set(EORO..'lock:bot:ttt'..bot_id,true) 
end end
if text and text == "تفعيل تنبيه التغيرات" and faeder11(msg) then
if faederdx1:get(EORO..'lock:bot:ttt'..bot_id) then 
...
faederdx1:del(EORO.."lock:bot:ttt2:"..msg.chat_id_)
end end
...
faederdx1:set(EORO.."lock:bot:ttt2:"..msg.chat_id_,"ok")
end end
--     By Developer EORO     -- 
if text == 'تفعيل جلب الصوره' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then   
if faederdx1:get(EORO..'lock:get:photo'..msg.chat_id_) then
...
if not faederdx1:get(EORO..'lock:get:photo'..msg.chat_id_) then
faeder = '*⌯︙تم تعطيل جلب الصوره الشخصيه ،*'  
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:set(EORO..'lock:get:photo'..msg.chat_id_,true) 
else
...
if not faederdx1:get(EORO.."bot:enable:"..msg.chat_id_) then
...
faederdx1:del(EORO.."bot:charge:"..gp[2])
local v = tonumber(bot_owner)       
end
--     By Developer EORO     -- 
if text and text:match("^تفعيل كل الكروبات$") and faeder11(msg) then
local gps = faederdx1:smembers(EORO.."bot:groups") or 0
local gps2 = faederdx1:smembers("faeder:addg"..bot_id) or 0
for i=1,#gps do
faederdx1:sadd("faeder:addg"..bot_id, gps[i])
faederdx1:set(EORO.."bot:enable:"..gps[i],true)
faederdx1:set( EORO.."bot:charge:"..gps[i],true)
end
...
faederdx1:del(EORO.."bot:enable:"..gps[i],true)
faederdx1:del( EORO.."bot:charge:"..gps[i],true)
end
...
faederdx1:set(EORO.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
faederdx(tostring((faederdx1:get(EORO.."bot:leader:gr") or bot_owner)), 0, 1, "⌯︙هناك من بحاجه للمساعده  \n⌯︙معرف الشخص ⌯» @"..(result.username_ or "لا يوجد").."\n⌯︙ايدي الشخص ⌯» `"..msg.sender_user_id_.."`\n⌯︙معلومات المجموعه ،  \n\n⌯︙اسم المجموعه ⌯»  *"..f2.title_.."*\n⌯︙ايدي المجموعه ⌯» `"..msg.chat_id_.."`\n⌯︙رابط المجموعه ، \n⌯︙"..(t2.invite_link_ or "Error").."\n" , 1, 'md')
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
local num = (faederdx1:scard(EORO.."bot:groups"))
local list = faederdx1:smembers(EORO.."bot:groups")
local text = "~ Groups_Bots_In_the_Bot_Of_Source_Faeder ~ @Faeder_ch\n\n"
for k,v in pairs(list) do
local GroupsMonsh = faederdx1:scard(EORO.."bot:monsh:"..v) or 0
local GroupsOwner = faederdx1:scard(EORO.."bot:owners:"..v) or 0
local GroupsMod = faederdx1:scard(EORO.."bot:momod:"..v) or 0
local Groupslink = faederdx1:get(EORO.."bot:group:link" ..v)
if result.first_name_ then
...
faederdx1:setex(EORO.."Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..'\n⌯︙ارسل لي سواء \n⌯︙❨ ملصق ، متحركه ، صوره ، رساله ❩ \nللخروج ارسل ،  ( الغاء ) \n '
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
return false
end 
if faederdx1:get(EORO.."Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم الغاء امر الاذاعه ،", 1, 'md')
faederdx1:del(EORO.."Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
list = faederdx1:smembers(EORO..'bot:userss') 
if msg.content_.text_ then
for k,v in pairs(list) do 
...
faederdx1:setex(EORO.."Send:Gp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..'\n⌯︙ارسل لي سواء \n⌯︙❨ ملصق ، متحركه ، صوره ، رساله ❩ \nللخروج ارسل ،  ( الغاء ) \n '
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
return false
end 
if faederdx1:get(EORO.."Send:Gp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم الغاء امر الاذاعه ،", 1, 'md')
faederdx1:del(EORO.."Send:Gp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
list = faederdx1:smembers(EORO..'bot:groups') 
if msg.content_.text_ then
for k,v in pairs(list) do 
faederdx(v, 0, 1, '['..msg.content_.text_..']', 1, 'md')
end
...
faederdx1:setex(EORO.."Send:FwdGp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..'\n⌯︙ارسل الرساله الان لتوجيهها\nللخروج ارسل ،  ( الغاء ) \n '
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
return false
end 
if faederdx1:get(EORO.."Send:FwdGp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم الغاء امر الاذاعه ،", 1, 'md')
faederdx1:del(EORO.."Send:FwdGp" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
local list = faederdx1:smembers(EORO..'bot:groups')   
for k,v in pairs(list) do  
...
faederdx1:setex(EORO.."Send:FwdPv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..'\n⌯︙ارسل الرساله الان لتوجيهها\nللخروج ارسل ،  ( الغاء ) \n '
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
return false
end 
if faederdx1:get(EORO.."Send:FwdPv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم الغاء امر الاذاعه ،", 1, 'md')
faederdx1:del(EORO.."Send:FwdPv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
local list = faederdx1:smembers(EORO..'bot:userss')   
for k,v in pairs(list) do  
tdcli_function({ID="ForwardMessages",
chat_id_ = v,
from_chat_id_ = msg.chat_id_,
...
faederdx1:set(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'','del_repgp1')
...
faederdx1:del(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
faederdx1:del(EORO..'gif_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'voice_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'audio_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'photo_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'stecker_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'video_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'file_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:del(EORO..'text_repgp'..msg.content_.text_..''..msg.chat_id_..'')
faederdx1:srem(EORO..'rep_owner'..msg.chat_id_..'',msg.content_.text_)
return false end end
--     By Developer EORO     -- 
if msg.content_.text_ == 'اضف رد' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) then
faederdx1:set(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'','set_repgp')
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙حسننا ارسل الكلمه الان " ,  1, "md")
return false    end
if msg.content_.text_ then
local content_faederdx12 = faederdx1:get(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
if content_faederdx12 == 'set_repgp' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الرد سواء كان : \n⌯︙❨ ملف ، ملصق ، متحركه ، صوره\n ، فيديو ، بصمه ، صوت ، رساله ❩\n⌯︙يمكنك اضافه الى النص : \n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n- `#username`  معرف المستخدم\n- `#msgs`  عدد الرسائل\n- `#name`  اسم المستخدم\n- `#id`  ايدي المستخدم\n- `#stast`  رتبه المستخدم\n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n⌯︙للخروج ارسل  ( الغاء )\n " ,  1, "md")
faederdx1:set(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'','save_repgp')
faederdx1:set(EORO..'addreplaygp:'..msg.sender_user_id_..''..msg.chat_id_..'',msg.content_.text_)
faederdx1:sadd(EORO..'rep_owner'..msg.chat_id_..'',msg.content_.text_)
faederdx1:set(EORO..'delrep_owner'..msg.chat_id_..'',msg.content_.text_)
return false
end end
text = msg.content_.text_
...
faederdx1:set(EORO.."add:repallt"..msg.sender_user_id_,'del_rep1')
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙حسننا ارسل الكلمة لحذفها " ,  1, "md")
return false
end
if msg.content_.text_ then
...
faederdx(msg.chat_id_, msg.id_, 1,'⌯︙الكلمه ،*('..msg.content_.text_..')* تم حذفها ',  1, "md")
faederdx1:del(EORO.."add:repallt"..msg.sender_user_id_)
faederdx1:del(EORO.."gif_repall"..msg.content_.text_)
faederdx1:del(EORO.."voice_repall"..msg.content_.text_)
faederdx1:del(EORO.."audio_repall"..msg.content_.text_)
faederdx1:del(EORO.."photo_repall"..msg.content_.text_)
faederdx1:del(EORO.."stecker_repall"..msg.content_.text_)
faederdx1:del(EORO.."video_repall"..msg.content_.text_)
faederdx1:del(EORO.."file_repall"..msg.content_.text_)
faederdx1:del(EORO.."text_repall"..msg.content_.text_)
faederdx1:del(EORO.."rep_sudo",msg.content_.text_)
return false
end end 
--     By Developer EORO     -- 
if msg.content_.text_ == 'اضف رد عام' and is_sudo(msg) or msg.content_.text_ == 'اضف رد للكل' and is_sudo(msg)  then
faederdx1:set(EORO.."add:repallt"..msg.sender_user_id_,'set_rep')
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙حسننا ارسل الكلمه الان " ,  1, "md")
return false    end
if msg.content_.text_ then
local content_faederdx12 = faederdx1:get(EORO.."add:repallt"..msg.sender_user_id_)
if content_faederdx12 == 'set_rep' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الرد سواء كان : \n⌯︙❨ ملف ، ملصق ، متحركه ، صوره\n ، فيديو ، بصمه ، صوت ، رساله ❩\n⌯︙يمكنك اضافه الى النص : \n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n- `#username`  معرف المستخدم\n- `#msgs`  عدد الرسائل\n- `#name`  اسم المستخدم\n- `#id`  ايدي المستخدم\n- `#stast`  رتبه المستخدم\n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n⌯︙للخروج ارسل  ( الغاء )\n " ,  1, "md")
faederdx1:set(EORO.."add:repallt"..msg.sender_user_id_,'save_rep')
faederdx1:set(EORO.."addreply2:"..msg.sender_user_id_, msg.content_.text_)
faederdx1:sadd(EORO.."rep_sudo",msg.content_.text_)
faederdx1:set(EORO.."delrep_sudo",msg.content_.text_)
return false 
end end
--     By Developer EORO     -- 
...
local redod = faederdx1:smembers(EORO..'rep_owner'..msg.chat_id_..'')
if #redod == 0 then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙لا توجد ردود مضافه" ,  1, "md")
else
msg_rep = "⌯︙ردود المدراء ⬇️،\n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n"
for k,v in pairs(redod) do
if faederdx1:get(EORO.."gif_repgp"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif faederdx1:get(EORO.."voice_repgp"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif faederdx1:get(EORO.."stecker_repgp"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif faederdx1:get(EORO.."text_repgp"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif faederdx1:get(EORO.."photo_repgp"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif faederdx1:get(EORO.."video_repgp"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif faederdx1:get(EORO.."file_repgp"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif faederdx1:get(EORO.."audio_repgp"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
faederdx1:del(EORO..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
faederdx1:del(EORO..'gif_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'voice_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'audio_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'photo_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'stecker_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'video_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'file_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'text_repgp'..v..msg.chat_id_)
faederdx1:del(EORO..'rep_owner'..msg.chat_id_..'',msg.content_.text_)
end
local faeder = '⌯︙اهلا عزيزي ،  '..renk_faeder(msg)..' \n⌯︙تم حذف ردود المدير\n'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
return false
...
local redod = faederdx1:smembers(EORO.."rep_sudo")
if #redod == 0 then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙لا توجد ردود مضافه" ,  1, "md")
else
local i = 1
...
for k,v in pairs(redod) do
if faederdx1:get(EORO.."gif_repall"..v) then
dp = 'متحركه 🎭'
elseif faederdx1:get(EORO.."voice_repall"..v) then
dp = 'بصمه 🎙'
elseif faederdx1:get(EORO.."stecker_repall"..v) then
dp = 'ملصق 🃏'
elseif faederdx1:get(EORO.."text_repall"..v) then
dp = 'رساله ✉'
elseif faederdx1:get(EORO.."photo_repall"..v) then
dp = 'صوره 🎇'
elseif faederdx1:get(EORO.."video_repall"..v) then
dp = 'فيديو 📽'
elseif faederdx1:get(EORO.."file_repall"..v) then
dp = 'ملف 📁'
elseif faederdx1:get(EORO.."audio_repall"..v) then
dp = 'اغنيه 🎶'
end
msg_rep = msg_rep ..k..' - (*'..v..'*) « » (*'..dp..'*)\n' 
end
...
for k,v in pairs(redod) do
faederdx1:del(EORO.."add:repallt"..v)
faederdx1:del(EORO.."gif_repall"..v)
faederdx1:del(EORO.."voice_repall"..v)
faederdx1:del(EORO.."audio_repall"..v)
faederdx1:del(EORO.."photo_repall"..v)
faederdx1:del(EORO.."stecker_repall"..v)
faederdx1:del(EORO.."video_repall"..v)
faederdx1:del(EORO.."file_repall"..v)
faederdx1:del(EORO.."text_repall"..v)
faederdx1:del(EORO.."rep_sudo",msg.content_.text_)
end
local faeder = '⌯︙اهلا عزيزي ،  '..renk_faeder(msg)..' \n⌯︙تم حذف ردود المطور\n'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
...
faederdx1:del(EORO..'bot:help', text)
faederdx1:del(EORO..'bot:help1', text)
faederdx1:del(EORO..'bot:help2', text)
faederdx1:del(EORO..'bot:help3', text) 
faederdx1:del(EORO..'bot:help4', text)
faederdx1:del(EORO..'bot:help5', text) 
faederdx1:del(EORO..'bot:help6', text) 
faederdx1:del(EORO..'bot:help7', text) 
faederdx1:del(EORO..'bot:help8', text) 
...
faederdx1:set(EORO..'bot:help0'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help0'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help0'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^الاوامر$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help')
local text =  [[
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
⌯︙اليك اوامر البوت ↓↓
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help01'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help01'..msg.sender_user_id_..'')
if faeder == 'msg' then 
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help01'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help1', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م1$") or  text:match("^م١$") and faeder11(msg) then 
local help = faederdx1:get(EORO..'bot:help1')
local text =  [[
⌯︙اوامر الحمايه
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
⌯︙قفل « » فتح
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help21'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help21'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help21'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help2', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م2$") or text:match("^م٢$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help2')
local text =  [[
⌯︙اوامر المشرفين
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help31'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help31'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help31'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help3', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end 
--     By Developer EORO     -- 
if text:match("^م3$") or text:match("^م٣$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help3')
local text =  [[
⌯︙اوامر الخدمة 
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
⌯︙الابراج
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help41'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help41'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help41'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help4', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م٤$") or text:match("^م4$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help4')
local text =  [[
⌯︙اوامر الوضع
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help51'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help51'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help51'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help5', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م٥$") or text:match("^م5$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help5')
local text =  [[
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help61'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help61'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help61'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help6', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م٦$") or text:match("^م6$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help6')
local text =  [[
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help71'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help71'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help71'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help7', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م٧$") or text:match("^م7$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help7') 
local text =  [[
⌯︙اوامر مسح القوائم  
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
⌯︙اوامر مسح المشرفين
...
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
faederdx1:set(EORO..'bot:help81'..msg.sender_user_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local faeder =  faederdx1:get(EORO..'bot:help81'..msg.sender_user_id_..'')
if faeder == 'msg' then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم حفظ الكليشه الجديده " ,  1, "md")
faederdx1:set(EORO..'bot:help81'..msg.sender_user_id_..'', 'no')
faederdx1:set(EORO..'bot:help8', text)
faederdx(msg.chat_id_, msg.id_, 1, text , 1, 'md')
return false end
end
--     By Developer EORO     -- 
if text:match("^م٨$") or text:match("^م8$") and faeder11(msg) then
local help = faederdx1:get(EORO..'bot:help8')
local text =  [[
⌯︙اوامر المطورين
         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •
⌯︙السيرفر 
...
faederdx1:setex(EORO.."bot:nerkh" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 100, true)
end end end
if is_leader(msg) then
if text and text:match("^مسح كليشه المطور$") then
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙تم مسح كليشه ", 1, "md")
faederdx1:del(EORO.."nerkh", nerkh)
end end
--     By Developer EORO     -- 
if is_leader(msg) then 
...
faederdx1:set(EORO..'bot:editid'..result.id_,result.content_.text_)
end 
...
if text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text:match("[Tt].[Mm][Ee]") then
if faederdx1:get(EORO..'bot:links:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end
...
if faederdx1:get(EORO..'bot:webpage:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end
if text:match("@") then
if faederdx1:get(EORO..'tags:lock'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end
if text:match("#") then 
if faederdx1:get(EORO..'bot:hashtag:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end
if text:match("[\216-\219][\128-\191]") then
if faederdx1:get(EORO..'bot:arabic:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end
if text:match("[A-Z]") or text:match("[a-z]") then
if faederdx1:get(EORO..'bot:english:mute'..result.chat_id_) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs)
end end end end
...
faederdx1:srem(EORO..'bot:groups',v)  
remgroup(v)   
...
faederdx1:sadd(EORO..'bot:groups',v)
print('\27[30;32m»» البوت ادمن في المجموعه \n\27[1;37m')
addgroup(v)
end end) end end end
-------------------------******* The Best Source *******-------------------------
-- END VERSION (24) EORO DX  
-- All The File By Developer EORO : @S_X_X_G 
-- Join In Chennel Source : @FAEDER_CH 
-- Join In Explanation Channel : @Learn_Faeder
