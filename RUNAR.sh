...
echo -e "\e[38;5;77m       •{ install source EORO [0%]  }•\e[0m"
apt update
apt upgrade
sudo apt-get update
sudo apt-get upgrade
echo -e "\e[38;5;77m       •{ install source EORO [10%]  }•\e[0m"
...
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @EORO_Ch }• }•\e[0m"
